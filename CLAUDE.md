...
Claude-specific root only. Shared repository policy is imported from `docs/agentic/*.md`; do not duplicate it here.
...
- Agent-specific documentation gateway: [docs/agentic/gateway.md](docs/agentic/gateway.md)
