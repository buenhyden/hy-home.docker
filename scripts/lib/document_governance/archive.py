...
def recover_legacy_parent_identities(root: pathlib.Path) -> set[str]:
    """Recover pre-taxonomy Spec/Plan/Task parents from the frozen ledger."""
    ...
    try:
        ...
        document = safe_load_unique(fenced)
