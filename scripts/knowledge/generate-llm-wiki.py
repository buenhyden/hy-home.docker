...
def render_index(candidates: Sequence[Candidate]) -> str:
    ...
    lines.extend([
        ...
        "## Related Documents", "", "- [LLM Wiki references](./README.md)", "- [LLM Wiki repository map](./ref-0083-repository-map.md)", "- [LLM Wiki maintenance guide](../../05.operations/catalog/00-workspace/0007-llm-wiki-maintenance/guide.md)", "- [Agent governance hub](../../00.agent-governance/README.md)",
    ])
    return "\n".join(lines) + "\n"
...
def render_coverage(candidates: Sequence[Candidate]) -> str:
    ...
    lines.extend([
        ...
        "## Related Documents", "", "- [Knowledge reference data](./README.md)", "- [Reference data](../README.md)", "- [LLM Wiki references](../../llm-wiki/README.md)", "- [LLM Wiki maintenance guide](../../../05.operations/catalog/00-workspace/0007-llm-wiki-maintenance/guide.md)",
    ])
    return "\n".join(lines) + "\n"
