...
| GitHub Workflow Contract Gate          | [check-github-workflow-contract.py](./validation/check-github-workflow-contract.py)          | Validate exact tracked workflow triggers, permissions, concurrency, job identities, semantic command ownership, and locally evidenced full-SHA Action dependencies through the typed workflow contract |
