...
lines: list[str] = [
    ...
    "regenerate it with `bash scripts/operations/generate-tech-stack-version-provenance.sh --write`;",
    "use `bash scripts/operations/generate-tech-stack-version-provenance.sh --check`",
...
lines.extend(
    [
        ...
        "## Refresh",
        "",
        "Run `bash scripts/operations/generate-tech-stack-version-provenance.sh --write` to",
        "write the snapshot. Run `bash scripts/operations/generate-tech-stack-version-provenance.sh --check`",
        "to verify freshness without writing.",
        "",
        "## Consumers",
        "",
