...
- If Graphify health is advisory, treat Graphify output as advisory only and corroborate conclusions against tracked source files, `docs/00.agent-governance/`, and active stage docs
