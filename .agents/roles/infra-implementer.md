...
- [Compose stack function](../skills/compose-stack-agent/SKILL.md)
- [Docker Compose patterns](../skills/docker-compose-patterns/SKILL.md)
- [Infrastructure validation](../skills/infra-validate/SKILL.md)
