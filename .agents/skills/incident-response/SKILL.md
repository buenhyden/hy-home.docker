...
description: Canonical ops procedure for incident-response; owned by incident-responder.
---

<!-- Generated by scripts/operations/provider_surface_renderer.py; source: docs/00.agent-governance/skills/incident-response.md -->
