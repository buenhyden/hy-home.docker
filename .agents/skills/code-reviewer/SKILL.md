---
name: code-reviewer
description: Canonical common procedure for code-reviewer; owned by code-reviewer.
---

<!-- Generated by scripts/operations/provider_surface_renderer.py; source: docs/00.agent-governance/skills/code-reviewer.md -->
