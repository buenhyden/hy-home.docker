...
description: Canonical infra function for compose-stack-agent; owned by infra-implementer.
---

<!-- Generated by scripts/operations/provider_surface_renderer.py; source: docs/00.agent-governance/agents/functions/compose-stack-agent.md -->
