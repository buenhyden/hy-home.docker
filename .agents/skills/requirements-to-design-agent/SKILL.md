...
description: "Canonical architecture procedure for requirements-to-design-agent; owned by rules-engineer."
---

<!-- Generated by scripts/operations/provider_surface_renderer.py; source: docs/00.agent-governance/skills/requirements-to-design-agent.md -->
...
- [Rules engineer](../../../docs/00.agent-governance/roles/rules-engineer.md)
- [ADR writing](../../../docs/00.agent-governance/skills/adr-writing.md)
- [Architecture scope](../../../docs/00.agent-governance/policies/stage-authoring-matrix.md)
