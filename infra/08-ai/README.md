...
1. Read the [Ollama Usage Guide](../../docs/05.operations/08-ai/ops-0056-ollama/guide.md).
2. Follow the [Open WebUI Usage Guide](../../docs/05.operations/08-ai/ops-0057-open-webui/guide.md) and [RAG Workflow Guide](../../docs/05.operations/08-ai/ops-0059-rag-workflow/guide.md).
3. Check the [operations policy index](../../docs/05.operations/08-ai/README.md) for GPU, model, access, and logging controls.
4. Consult the [AI Runbooks](../../docs/05.operations/08-ai/README.md) for NVIDIA driver, OOM, or Open WebUI troubleshooting.
...
| :--- | :--- | :--- |
| Inference | Ollama | `ollama/ollama:0.32.1` |
...
- [Operations guides - 08-ai](../../docs/05.operations/08-ai/README.md)
- [Operations policies - 08-ai](../../docs/05.operations/08-ai/README.md)
- [Operations runbooks - 08-ai](../../docs/05.operations/08-ai/README.md)
