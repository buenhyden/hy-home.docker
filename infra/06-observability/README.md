...
| Operations | [Guide index](../../docs/05.operations/06-observability/README.md), [Policy index](../../docs/05.operations/06-observability/README.md), [Runbook index](../../docs/05.operations/06-observability/README.md) |
...
1. Follow the [LGTM Stack Guide](../../docs/05.operations/06-observability/ops-0042-lgtm-stack/guide.md).
2. Refer to the [Alloy Collector Guide](../../docs/05.operations/06-observability/ops-0040-alloy/guide.md) for data piping.
3. Check the [Operations Policy](../../docs/05.operations/06-observability/README.md) for retention.
4. Consult the [Observability Runbook](../../docs/05.operations/06-observability/README.md) for recovery.
...
| Collector  | Grafana Alloy                  | v1.18.0                   |
| UI         | Grafana                        | v13.1.0                   |
