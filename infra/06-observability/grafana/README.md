...
| :--- | :--- |
| [System Guide](../../../docs/07.guides/06-observability/grafana.md) | Architecture, SSO mapping, and datasource integration details. |
| [Operational Policy](../../../docs/08.operations/06-observability/grafana.md) | Dashboard provisioning, RBAC, and datasource maintenance. |
| [Recovery Runbook](../../../docs/09.runbooks/06-observability/grafana.md) | Troubleshooting failing logins, dashboards, or service unavailability. |
