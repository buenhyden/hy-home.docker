...
| `mlflow`, `mlflow-db-provision` | `mlops`, `data-science` | tracking database on `mng-pg` and bucket-scoped SeaweedFS artifacts; the SDK path on `ai_net` is unauthenticated |
