...
`infra/09-tooling/terraform/` provides a standardized Terraform execution container. The service uses `hashicorp/terraform:1.16.2`, mounts a local `workspace/` directory, and exposes host cloud credential directories as read-only mounts for local IaC workflows.
...
| --- | --- | --- | --- |
| Engine | HashiCorp Terraform | `hashicorp/terraform:1.16.2` | IaC CLI |
...
- Terraform guide (`docs/05.operations/catalog/09-tooling/0068-terraform/guide.md`)
- IaC operations policy (`docs/05.operations/catalog/09-tooling/0068-terraform/policy.md`)
- Terraform recovery runbook (`docs/05.operations/catalog/09-tooling/0068-terraform/runbook.md`)
