...
| Operations | [Guide](../../../docs/05.operations/catalog/07-workflow/ops-0053-n8n/guide.md), [Policy](../../../docs/05.operations/catalog/07-workflow/ops-0053-n8n/policy.md), [Runbook](../../../docs/05.operations/catalog/07-workflow/ops-0053-n8n/runbook.md) |
...
- **PRD**: [07-workflow PRD](../../../docs/01.requirements/prd-0008-workflow.md)
- **ARD**: [07-workflow Architecture Description](../../../docs/02.architecture/descriptions/ad-0007-workflow-architecture.md)
- **ADR**: [N8N Integration ADR](../../../docs/02.architecture/decisions/adr-0007-airflow-n8n-hybrid-workflow.md)
...
- **Guide**: [n8n usage guide](../../../docs/05.operations/catalog/07-workflow/ops-0053-n8n/guide.md)
- **Policy**: [n8n operations policy](../../../docs/05.operations/catalog/07-workflow/ops-0053-n8n/policy.md)
- **Runbook**: [n8n recovery runbook](../../../docs/05.operations/catalog/07-workflow/ops-0053-n8n/runbook.md)
- **Spec**: [07-workflow Technical Spec](../../../docs/03.specs/spec-0008-workflow/spec.md)
