...
- Stable entry point: [docs/README.md](../../../docs/README.md). Exact Stage 05 path `docs/05.operations/guides/0053-n8n.md`; IDs `GDE-0053`, `POL-0053`, `RUN-0053`. Its isolated restore is planned and unexecuted.
