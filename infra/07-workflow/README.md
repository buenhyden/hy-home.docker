...
1. Read the [Airflow DAG basics guide](../../docs/05.operations/07-workflow/ops-0051-airflow-dag-basics/guide.md).
2. Follow the [n8n usage guide](../../docs/05.operations/07-workflow/ops-0053-n8n/guide.md).
3. Check the [Operations Policy](../../docs/05.operations/07-workflow/README.md) for scaling.
4. Consult the [Workflow Runbook](../../docs/05.operations/07-workflow/README.md) for failure recovery.
