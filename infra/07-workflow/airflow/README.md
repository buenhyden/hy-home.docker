...
7. **Traceability**: 모든 변경 사항은 관련 [Architecture Description](../../../docs/02.architecture/descriptions/0007-workflow-architecture.md) 또는 [Spec](../../../docs/03.specs/spec-0008-workflow/spec.md)과 연결되어야 합니다.
