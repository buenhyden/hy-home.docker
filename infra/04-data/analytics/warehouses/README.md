...
| Operations | [Guide](../../../../docs/05.operations/catalog/04-data/ops-0020-analytics-warehouses/guide.md), [Policy](../../../../docs/05.operations/catalog/04-data/ops-0020-analytics-warehouses/policy.md), [Runbook](../../../../docs/05.operations/catalog/04-data/ops-0020-analytics-warehouses/runbook.md) |
...
1. 아키텍처 컨텍스트는 [시스템 가이드](../../../../docs/05.operations/catalog/04-data/ops-0020-analytics-warehouses/guide.md)를 참조한다.
2. 자원 거버넌스는 [운영 정책](../../../../docs/05.operations/catalog/04-data/ops-0020-analytics-warehouses/policy.md)을 확인한다.
3. 유지보수 및 복구 절차는 [복구 런북](../../../../docs/05.operations/catalog/04-data/ops-0020-analytics-warehouses/runbook.md)을 사용한다.
...
- **System Guide**: [docs/05.operations/catalog/04-data/analytics/warehouses.md](../../../../docs/05.operations/catalog/04-data/ops-0020-analytics-warehouses/guide.md)
- **Policy**: [docs/05.operations/catalog/04-data/ops-0020-analytics-warehouses/policy.md](../../../../docs/05.operations/catalog/04-data/ops-0020-analytics-warehouses/policy.md)
- **Runbook**: [docs/05.operations/catalog/04-data/ops-0020-analytics-warehouses/runbook.md](../../../../docs/05.operations/catalog/04-data/ops-0020-analytics-warehouses/runbook.md)
