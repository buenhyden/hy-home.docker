...
| Operations | [Guide](../../../../docs/05.operations/04-data/ops-0018-analytics-ksqldb/guide.md), [Policy](../../../../docs/05.operations/04-data/ops-0018-analytics-ksqldb/policy.md), [Runbook](../../../../docs/05.operations/04-data/ops-0018-analytics-ksqldb/runbook.md) |
...
1. 아키텍처 및 사용법은 [ksqlDB 시스템 가이드](../../../../docs/05.operations/04-data/ops-0018-analytics-ksqldb/guide.md)를 참조한다.
2. 처리 규약 및 자원 할당은 [운영 정책](../../../../docs/05.operations/04-data/ops-0018-analytics-ksqldb/policy.md)을 따른다.
3. 스트림 지연이나 연결 이슈 발생 시 [복구 런북](../../../../docs/05.operations/04-data/ops-0018-analytics-ksqldb/runbook.md)을 참조한다.
4. ksqlDB를 시작하기 전에 Kafka 브로커와 Schema Registry의 상태를 확인한다.

5. ksqlDB 쿼리를 작성하거나 수정하기 전에 Kafka 토픽 구조를 먼저 파악한다.
6. 서비스 재시작 시 스트림 처리 오프셋(Offset) 영향을 고려한다.
7. 구성 변경 시 Kafka 브로커와의 네트워크 가시성을 확인한다.
...
- **System Guide**: [docs/05.operations/04-data/analytics/ksqldb.md](../../../../docs/05.operations/04-data/ops-0018-analytics-ksqldb/guide.md)
- **Policy**: [docs/05.operations/04-data/ops-0018-analytics-ksqldb/policy.md](../../../../docs/05.operations/04-data/ops-0018-analytics-ksqldb/policy.md)
- **Runbook**: [docs/05.operations/04-data/ops-0018-analytics-ksqldb/runbook.md](../../../../docs/05.operations/04-data/ops-0018-analytics-ksqldb/runbook.md)
