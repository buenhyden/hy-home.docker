...
1. 아키텍처 및 사용법은 [ksqlDB 시스템 가이드](../../../../docs/05.operations/catalog/04-data/0018-ksqldb/guide.md)를 참조한다.
2. 처리 규약 및 자원 할당은 [운영 정책](../../../../docs/05.operations/catalog/04-data/0018-ksqldb/policy.md)을 따른다.
3. 스트림 지연이나 연결 이슈 발생 시 [복구 런북](../../../../docs/05.operations/catalog/04-data/0018-ksqldb/runbook.md)을 참조한다.
...
- **System Guide**: [docs/05.operations/catalog/04-data/analytics/ksqldb.md](../../../../docs/05.operations/catalog/04-data/0018-ksqldb/guide.md)
- **Policy**: [docs/05.operations/catalog/04-data/0018-ksqldb/policy.md](../../../../docs/05.operations/catalog/04-data/0018-ksqldb/policy.md)
- **Runbook**: [docs/05.operations/catalog/04-data/0018-ksqldb/runbook.md](../../../../docs/05.operations/catalog/04-data/0018-ksqldb/runbook.md)
