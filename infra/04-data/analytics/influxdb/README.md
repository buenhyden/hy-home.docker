...
1. 아키텍처 세부 사항은 [InfluxDB 시스템 가이드](../../../../docs/05.operations/catalog/04-data/0017-influxdb/guide.md)를 참조한다.
2. 데이터 보존 및 보안 규약은 [운영 정책](../../../../docs/05.operations/catalog/04-data/0017-influxdb/policy.md)을 따른다.
3. 수집 장애 발생 시 [복구 런북](../../../../docs/05.operations/catalog/04-data/0017-influxdb/runbook.md)을 참조한다.
...
- **System Guide**: [docs/05.operations/catalog/04-data/analytics/influxdb.md](../../../../docs/05.operations/catalog/04-data/0017-influxdb/guide.md)
- **Policy**: [docs/05.operations/catalog/04-data/0017-influxdb/policy.md](../../../../docs/05.operations/catalog/04-data/0017-influxdb/policy.md)
- **Runbook**: [docs/05.operations/catalog/04-data/0017-influxdb/runbook.md](../../../../docs/05.operations/catalog/04-data/0017-influxdb/runbook.md)
