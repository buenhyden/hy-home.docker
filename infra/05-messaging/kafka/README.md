...
| Operations | [Guide](../../../docs/05.operations/05-messaging/ops-0036-kafka/guide.md), [Policy](../../../docs/05.operations/05-messaging/ops-0036-kafka/policy.md), [Runbook](../../../docs/05.operations/05-messaging/ops-0036-kafka/runbook.md) |
...
1. **Bootstrap**: [Kafka KRaft Guide](../../../docs/05.operations/05-messaging/ops-0036-kafka/guide.md)를 읽고 클러스터 초기 구성 방식을 파악한다.
...
4. **Validation**: [Messaging Runbook](../../../docs/05.operations/05-messaging/ops-0036-kafka/runbook.md)의 점검 절차를 수행한다.
...
- **Guide**: [Kafka Guide](../../../docs/05.operations/05-messaging/ops-0036-kafka/guide.md)
- **Policy**: [Messaging Ops](../../../docs/05.operations/05-messaging/ops-0036-kafka/policy.md)
- **Runbook**: [Messaging Recovery](../../../docs/05.operations/05-messaging/ops-0036-kafka/runbook.md)
