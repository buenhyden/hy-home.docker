...
1. Read the [Kafka Guide](../../docs/05.operations/05-messaging/ops-0036-kafka/guide.md) for cluster ops.
2. Follow the [RabbitMQ Guide](../../docs/05.operations/05-messaging/ops-0038-rabbitmq/guide.md) for queues.
3. Check the [Operations Policy](../../docs/05.operations/05-messaging/README.md) for topic, secret, and queue controls.
4. Consult the [Messaging Runbook](../../docs/05.operations/05-messaging/README.md) for recovery.
...
- [Kafka guide](../../docs/05.operations/05-messaging/ops-0036-kafka/guide.md)
- [RabbitMQ guide](../../docs/05.operations/05-messaging/ops-0038-rabbitmq/guide.md)
