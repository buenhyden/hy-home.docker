...
| ---------- | --------------------------------- | ------------------------- |
| Router     | Traefik v3.7.8                    | Primary dynamic router    |
...
1. Review the [Gateway operations guides](../../docs/05.operations/01-gateway/README.md) to understand traffic flow.
2. Ensure secrets are generated via `scripts/operations/gen-secrets.sh` before deployment.
3. Follow the [Gateway setup guide](../../docs/05.operations/01-gateway/ops-0012-setup/guide.md) for initial deployment boundaries.
...
- [Gateway Guides](../../docs/05.operations/01-gateway/README.md)
- [Operations Policy](../../docs/05.operations/01-gateway/README.md)
- [Emergency Runbooks](../../docs/05.operations/01-gateway/README.md)
