...
1. Read the [Vault Operations Guide](../../docs/05.operations/03-security/ops-0016-vault/guide.md) for initialization and AppRole bootstrap boundaries.
2. Follow the [Operations Policy](../../docs/05.operations/03-security/README.md) for unseal protocols.
3. Use the [Security Runbook](../../docs/05.operations/03-security/README.md) for emergency recovery.
...
- [docs/05.operations/03-security](../../docs/05.operations/03-security/README.md) - Governance standards.
