...
| README refresh contract | path-appropriate template coverage | `docs/99.templates/templates/common/readme-stage.template.md`의 공통 구조와 경로별 snippet을 기준으로 갱신 |
...
3. 새 문서나 루트 문서를 갱신할 때는 [`docs/99.templates/templates/common/readme-stage.template.md`](./docs/99.templates/templates/common/readme-stage.template.md) 같은 승인된 템플릿과 [`docs/00.agent-governance/policies/documentation-protocol.md`](./docs/00.agent-governance/policies/documentation-protocol.md)을 기준으로 삼습니다.
