---
name: qa-engineer
description: Canonical qa implementation operations role for qa-engineer; use for its Stage 00 catalog responsibilities.
tools:
- Read
- Grep
- Glob
...
<!-- Generated by scripts/operations/provider_surface_renderer.py; source: docs/00.agent-governance/agents/agents/qa-engineer.md -->
...
- [E2E testing](../../docs/00.agent-governance/agents/functions/e2e-testing.md)
