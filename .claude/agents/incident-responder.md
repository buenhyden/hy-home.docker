...
- **Output**:
  - `docs/05.operations/incidents/YYYY/<id>.md` (live incident record).
  - `docs/05.operations/incidents/postmortems/YYYY/<id>-postmortem.md` (postmortem, SEV1/2 mandatory).
