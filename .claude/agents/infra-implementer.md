...
description: Canonical infra role for infra-implementer; owned by Stage 00.
tools:
- Read
- Grep
- Glob
...
<!-- Generated by scripts/operations/provider_surface_renderer.py; source: docs/00.agent-governance/roles/infra-implementer.md -->
