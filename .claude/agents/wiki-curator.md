...
- Regenerate and validate `docs/90.references/llm-wiki/llm-wiki-index.md`.
...
- **Outputs**: refreshed `llms.txt`, `docs/90.references/llm-wiki/llm-wiki-index.md`, `docs/90.references/llm-wiki/repository-map.md`, and related README links.
