---
name: doc-writer
description: Canonical docs role for doc-writer; owned by Stage 00.
tools:
- Read
- Grep
- Glob
...
<!-- Generated by scripts/operations/provider_surface_renderer.py; source: docs/00.agent-governance/roles/doc-writer.md -->
...
- [Knowledge map](../../docs/00.agent-governance/skills/knowledge-map-agent.md)
- [Operations runbook authoring](../../docs/00.agent-governance/skills/ops-runbook-agent.md)
