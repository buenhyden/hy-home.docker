...
description: "Canonical infra procedure for compose-stack-agent; owned by infra-implementer."
---

<!-- Generated by scripts/operations/provider_surface_renderer.py; source: docs/00.agent-governance/skills/compose-stack-agent.md -->
...
- [Docker Compose patterns](../../../docs/00.agent-governance/skills/docker-compose-patterns.md)
- [Infrastructure validation](../../../docs/00.agent-governance/skills/infra-validate.md)
