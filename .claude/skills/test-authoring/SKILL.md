---
name: "test-authoring"
description: "Canonical qa procedure for test-authoring; owned by qa-engineer."
---

<!-- Generated by scripts/operations/provider_surface_renderer.py; source: docs/00.agent-governance/skills/test-authoring.md -->
