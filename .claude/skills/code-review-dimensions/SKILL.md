...
description: Canonical common procedure for code-review-dimensions; owned by code-reviewer.
---

<!-- Generated by scripts/operations/provider_surface_renderer.py; source: docs/00.agent-governance/skills/code-review-dimensions.md -->
