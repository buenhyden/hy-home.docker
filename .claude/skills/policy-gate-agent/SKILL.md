...
description: Canonical agentic procedure for policy-gate-agent; owned by rules-engineer.
---

<!-- Generated by scripts/operations/provider_surface_renderer.py; source: docs/00.agent-governance/skills/policy-gate-agent.md -->
