...
description: Canonical qa function for provider-model-evaluation; owned by eval-engineer.
---

<!-- Generated by scripts/operations/provider_surface_renderer.py; source: docs/00.agent-governance/agents/functions/provider-model-evaluation.md -->
...
- [Evaluation engineer role](../../../docs/00.agent-governance/agents/agents/eval-engineer.md)
- [Provider model contract](../../../docs/00.agent-governance/contracts/provider-models.yaml)
- [Agent output evaluation fixtures](../../../docs/90.references/data/governance/ref-0064-agent-output-eval-fixtures.md)
- [Spec 134](../../../docs/03.specs/spec-0134-agent-governance-canonical-convergence/spec.md)
