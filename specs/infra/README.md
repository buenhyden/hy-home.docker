# Infrastructure Technical Specifications (`specs/infra/`)

This directory contains implementation-level technical specifications for the Hy-Home infrastructure tiers. These documents serve as the source of truth for "How" components are built and integrated.

## Index of Infrastructure Specs

| Document | Tier | Reference ARD |
| :--- | :--- | :--- |
...
---
> [!NOTE]
> All specifications MUST follow the `templates/engineering/spec-template.md`.
