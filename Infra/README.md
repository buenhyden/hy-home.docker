...
### Databases & Storage
- [**PostgreSQL Cluster**](./postgresql-cluster/README.md): HA PostgreSQL Cluster (Patroni).
- [**Redis Cluster**](./redis-cluster/README.md): HA Redis Cluster.
- [**Mng-DB**](./mng-db/README.md): Shared Monitoring DB (Redis/Postgres).
...
### Observability & AI
- [**Observability**](./observability/README.md): LGTM Stack (Loki, Grafana, Tempo, Prometheus).
- [**Ollama**](./ollama/README.md): LLM Inference Engine.

### Utilities
- [**Harbor**](./harbor/README.md): Container Registry.
- [**Mail**](./mail/README.md): MailHog (Email Testing Tool).
