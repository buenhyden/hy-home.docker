...
## Corpus Check
- 837 files · ~699,488 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14567 nodes · 14339 edges · 1097 communities (1020 shown, 77 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 332 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `609d08fa`
...
## Knowledge Gaps
- **9879 isolated node(s):** `printWidth`, `singleQuote`, `semi`, `trailingComma`, `arrowParens` (+9874 more)
...
- **Why does `Prometheus rule group: prometheus_alerts` connect `Community 715` to `Prometheus Alert Rule Group`?**
  _High betweenness centrality (0.000) - this node is a cross-community bridge._
...
- **What connects `printWidth`, `singleQuote`, `semi` to the rest of the system?**
  _10452 weakly-connected nodes found - possible documentation gaps or missing edges._
