...
## Corpus Check
- 842 files · ~708,624 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14769 nodes · 14722 edges · 1108 communities (1031 shown, 77 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 332 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `92fb5b00`
...
## Knowledge Gaps
- **9853 isolated node(s):** `printWidth`, `singleQuote`, `semi`, `trailingComma`, `arrowParens` (+9848 more)
...
- **Why does `Secret Exposure Escalation` connect `Community 157` to `Airflow Airbyte Failure Worker`, `Community 583`, `Data Cluster Cassandra Hardening`, `Community 1004`, `Community 365`?**
  _High betweenness centrality (0.000) - this node is a cross-community bridge._
...
- **What connects `printWidth`, `singleQuote`, `semi` to the rest of the system?**
  _10426 weakly-connected nodes found - possible documentation gaps or missing edges._
