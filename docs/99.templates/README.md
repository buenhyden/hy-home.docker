...
- 운영 문서 cross-link는 복사된 Target 기준으로 계산한다. 예: `docs/05.operations/guides/<topic>.md`에서는 `../../02.architecture/...`, `docs/05.operations/guides/<domain>/<topic>.md`에서는 `../../../02.architecture/...`를 사용한다.
