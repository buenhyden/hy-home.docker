...
5. Archive 대상은 [corpus migration contract](../../support/corpus-migration-contract.md)와 [archive and retention contract](../../support/archive-retention-contract.md)에서 분류와 조건을 확인한다.
...
- [corpus migration contract](../../support/corpus-migration-contract.md)
- [archive and retention contract](../../support/archive-retention-contract.md)
