...
| [document-metadata-profiles.yaml](./document-metadata-profiles.yaml) | Sole machine owner for profiles, archive selectors, README profiles, 22 template roles, matchers, headings, lifecycle, parents, and exceptions. |
| [sdlc-document-contract.md](./sdlc-document-contract.md) | Owns human roles and iterative feedback from PRD through Operations. |
