...
status: draft
---
<!-- Target: docs/07.guides/11-laboratory/open-notebook.md -->
...
3. `open_notebook_password` secret 값으로 UI 로그인을 확인한다.
...
- **Runbook**: [../../09.runbooks/11-laboratory/open-notebook.md](../../09.runbooks/11-laboratory/open-notebook.md)
