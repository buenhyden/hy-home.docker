...
docs/03.specs/0136-sdlc-taxonomy-convergence/spec.md. The starting commit for the
...
- Create: docs/03.specs/0136-sdlc-taxonomy-convergence/tasks/tsk-0001-taxonomy-convergence.md
...
~~~bash
git add docs/03.specs/0136-sdlc-taxonomy-convergence/tasks/tsk-0001-taxonomy-convergence.md scripts/lib/document_governance scripts/requirements.txt tests/validation/test_document_taxonomy.py
...
- Rename: docs/04.execution/plans/2026-08-07-sdlc-taxonomy-convergence.md
  to docs/03.specs/0136-sdlc-taxonomy-convergence/plan.md
