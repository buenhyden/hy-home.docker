...
| REQ-20 | Task- and Git-owned delivery evidence boundary, purpose, trigger, owner, consumer, system, and rules                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `sdlc-document-roles.md`                |
...
| ---------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- |
| `docs/90.references/data/0082-llm-wiki-index/README.md`                                                      | Tracked safe-path set or canonical route changes                                                                                          | `scripts/knowledge/generate-llm-wiki-index.sh`                                                                                                                                                             | `bash scripts/knowledge/generate-llm-wiki-index.sh --check`                               | PASS                                                                                                                                                   | Regenerate after the canonical route switch and require PASS.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Not run; Task-owned                          |
| `docs/90.references/data/0076-llm-wiki-stage-category-coverage/README.md`                              | Tracked Stage/category path set changes                                                                                                   | `scripts/knowledge/generate-llm-wiki-coverage.sh`                                                                                                                                                          | `bash scripts/knowledge/generate-llm-wiki-coverage.sh --check`                            | FAIL                                                                                                                                                   | Regenerate after the canonical route switch and require PASS; the baseline FAIL is not acceptable at deletion.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Not run; Task-owned                          |
...
`docs/03.specs/0137-agentic-research-pack-rebuild/plan.md` with
artifact ID `plan:2026-08-08-agentic-research-pack-rebuild` and direct parent
`spec:137-agentic-research-pack-rebuild`, and
`docs/03.specs/0137-agentic-research-pack-rebuild/tasks/tsk-0001-rebuild.md` with
...
- [Spec 136](../0136-sdlc-taxonomy-convergence/spec.md)
