...
| D6 — two infrastructure/security leaves | Current draft authoring: Docker Compose infrastructure and security-governance analysis plus README and this Task only. Terminal review remains Not Run in-tree/external. |
...
| D6 — infrastructure and security draft unit | No commit yet | Current four-path authoring only; terminal review is Not Run in-tree/external. D7 remains Not Run; final acceptance/integration are deferred. |
