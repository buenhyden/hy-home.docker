...
| D5 — three delivery/quality leaves | Current draft authoring: automation pipeline workflow, quality CI/formatting, and V&V analysis plus README and this Task only. Terminal review remains Not Run in-tree/external. |
...
| D5 — delivery and quality draft unit | No commit yet | Current five-path authoring only; author checks are recorded above and terminal review is Not Run in-tree/external. D6-D7 remain Not Run; final acceptance/integration are deferred. |
