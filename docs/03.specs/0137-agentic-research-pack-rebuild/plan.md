...
bash /home/hy/.codex/plugins/cache/openai-curated-remote/superpowers/6.2.0/skills/subagent-driven-development/scripts/task-brief \
  docs/03.specs/0137-agentic-research-pack-rebuild/plan.md TASK_NUMBER \
...
bash /home/hy/.codex/plugins/cache/openai-curated-remote/superpowers/6.2.0/skills/subagent-driven-development/scripts/review-package \
  docs/03.specs/0137-agentic-research-pack-rebuild/plan.md BASE HEAD \
...
| -------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Execution evidence               | Create `docs/03.specs/0137-agentic-research-pack-rebuild/tasks/tsk-0001-rebuild.md`; modify `docs/04.execution/tasks/README.md`                                               |
...
- Create: `docs/03.specs/0137-agentic-research-pack-rebuild/tasks/tsk-0001-rebuild.md`
...
```bash
git add docs/03.specs/0137-agentic-research-pack-rebuild/tasks/tsk-0001-rebuild.md \
...
`docs/03.specs/0137-agentic-research-pack-rebuild/tasks/tsk-0001-rebuild.md`. Record
...
1. Modify
   `docs/03.specs/0137-agentic-research-pack-rebuild/tasks/tsk-0001-rebuild.md` only
...
3. `docs/03.specs/0137-agentic-research-pack-rebuild/tasks/tsk-0001-rebuild.md` only
...
Execute the approved implementation outcome described in the preserved plan above.

## Dependencies

The preserved context, inputs, approvals, and linked authority above define the dependencies.

## Execution Sequence

The preserved work breakdown and implementation phases above define the execution sequence.

## Risk and Rollback

The preserved risk, rollback, and recovery guidance above remains authoritative.

## Verification

The preserved verification commands and completion criteria above remain authoritative.
