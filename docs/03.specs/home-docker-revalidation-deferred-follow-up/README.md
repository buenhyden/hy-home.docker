<!-- Target: docs/03.specs/home-docker-revalidation-deferred-follow-up/README.md -->
...
`docs/03.specs/home-docker-revalidation-deferred-follow-up`는 2026-05-25 Home Docker workspace audit 이후 재검증과 deferred 항목 추적 계약을 보존합니다.
