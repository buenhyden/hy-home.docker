...
| MinIO community maintenance state and storage alternatives | m0021 MinIO decision plus [MinIO operations](../../../05.operations/catalog/04-data/0023-minio/guide.md) | Preserve HOME S3 while requiring a separately designed migration evaluation | No replacement, object migration or credential change is approved |
