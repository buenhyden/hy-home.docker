...
| SPEC-0177 | [Archive Disposition Enforcement](0177-archive-disposition-enforcement/spec.md) | active package that moves the link validator, the Tombstone and Migration contracts, and the Retention Envelope onto the Stage 98 model the policy states behind a Registry switch, and accepts ADR-0035, superseding ADR-0033. The operator answered its four Open Questions on 2026-09-15. Carries an active [Plan](0177-archive-disposition-enforcement/plan.md) and an in-progress [Task](0177-archive-disposition-enforcement/tasks/tsk-0001-archive-disposition-enforcement.md) |
| SPEC-0178 | [Archive Occupancy, Route Citation, and Frozen Identity](0178-archive-occupancy-citation-and-frozen-identity/spec.md) | approved package proposing ADR-0036: a completed Task admitted in an unfinished package, route records closed to every citation, preserved units compared with their catalog `Source`, and a closure date required on a resolved Incident. Two independent approval reviews settled on 2026-09-16. It activates only after SPEC-0177 completes and carries an approved [Plan](0178-archive-occupancy-citation-and-frozen-identity/plan.md) and a ready [Task](0178-archive-occupancy-citation-and-frozen-identity/tasks/tsk-0001-archive-occupancy-citation-and-frozen-identity.md) |
