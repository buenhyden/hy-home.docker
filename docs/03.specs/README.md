...
├── 123-agentic-engineering-audit-remediation/ # Active I-03 fail-closed Git discovery remediation; re-review pending
...
| Active agentic audit remediation; I-03 Git discovery fix pending exact-range re-review | `123-agentic-engineering-audit-remediation/spec.md` |
