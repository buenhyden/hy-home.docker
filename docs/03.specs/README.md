...
| SPEC-0178 | [Archive Occupancy, Route Citation, and Frozen Identity](0178-archive-occupancy-citation-and-frozen-identity/spec.md) | review package proposing ADR-0036: a completed Task admitted in an unfinished package, route records closed to every citation, preserved units compared with their catalog `Source`, and a closure date required on a resolved Incident. It activates only after SPEC-0177 completes and carries a draft [Plan](0178-archive-occupancy-citation-and-frozen-identity/plan.md) and [Task](0178-archive-occupancy-citation-and-frozen-identity/tasks/tsk-0001-archive-occupancy-citation-and-frozen-identity.md) |
