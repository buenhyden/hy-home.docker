...
| SPEC-0173 | [Governance and QA Surface Convergence](0173-governance-qa-surface-convergence/spec.md) | active with active [Plan](0173-governance-qa-surface-convergence/plan.md), Task 1 milestone complete with lifecycle in progress, Task 2 ready, and Tasks 3-6 draft |
