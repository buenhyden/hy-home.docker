...
| SPEC-0177 | [Archive Disposition Enforcement](0177-archive-disposition-enforcement/spec.md) | approved package that moves the link validator, the Tombstone and Migration contracts, and the Retention Envelope onto the Stage 98 model the policy states, and accepts ADR-0035, superseding ADR-0033. The operator answered its four Open Questions on 2026-09-15. Carries an approved [Plan](0177-archive-disposition-enforcement/plan.md) and a ready [Task](0177-archive-disposition-enforcement/tasks/tsk-0001-archive-disposition-enforcement.md) |
