...
| SPEC-0173 | [Governance and QA Surface Convergence](0173-governance-qa-surface-convergence/spec.md) | active with active [Plan](0173-governance-qa-surface-convergence/plan.md), Tasks 1-4 milestone complete, Task 5 in progress, and Task 6 draft |
