...
| SPEC-0175 | [Governance Knowledge and Prompt Surface](0175-governance-knowledge-and-prompt-surface/spec.md) | draft package defining the canonical `.agents/knowledge/` and `.agents/prompts/` categories, with a draft [Plan](0175-governance-knowledge-and-prompt-surface/plan.md) and draft [Task](0175-governance-knowledge-and-prompt-surface/tasks/tsk-0001-knowledge-and-prompt-surface.md) |
