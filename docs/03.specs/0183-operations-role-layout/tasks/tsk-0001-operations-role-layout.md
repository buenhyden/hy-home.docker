...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `catalog/00-workspace/0001-common-optimizations-template-exceptions/policy.md` | `POL-0001` | policy | 00-workspace / 0001-common-optimizations-template-exceptions | active | [] | 4 / 1 | none found | `policies/0001-common-optimizations-template-exceptions.md` | move | V1 |
...
| `catalog/00-workspace/0004-harness-agent-first-engineering/policy.md` | `POL-0004` | policy | 00-workspace / 0004-harness-agent-first-engineering | active | SPEC-0094 | 3 / 2 | none found | `policies/0004-harness-agent-first-engineering.md` | move | V1 |
| `catalog/00-workspace/0004-harness-agent-first-engineering/runbook.md` | `RUN-0004` | runbook | 00-workspace / 0004-harness-agent-first-engineering | active | SPEC-0094 | 2 / 2 | none found | `runbooks/0004-harness-agent-first-engineering.md` | move | V1 |
| `catalog/00-workspace/0006-infrastructure-optimization-governance/policy.md` | `POL-0006` | policy | 00-workspace / 0006-infrastructure-optimization-governance | active | [] | 5 / 1 | none found | `policies/0006-infrastructure-optimization-governance.md` | move | V1 |
...
| `catalog/00-workspace/0009-release-management/runbook.md` | `RUN-0009` | runbook | 00-workspace / 0009-release-management | active | [] | 8 / 1 | none found | `runbooks/0009-release-management.md` | move | V1 |
...
| `catalog/00-workspace/0078-compose-profile-vocabulary/policy.md` | `POL-0078` | policy | 00-workspace / 0078-compose-profile-vocabulary | active | [] | 13 / 12 | none found | `policies/0078-compose-profile-vocabulary.md` | move | V1 |
...
| `catalog/00-workspace/0098-cold-start-and-reboot/runbook.md` | `RUN-0098` | runbook | 00-workspace / 0098-cold-start-and-reboot | draft | SPEC-0182 | 1 / 1 | none found | `runbooks/0098-cold-start-and-reboot.md` | move | V1 |
...
| `catalog/01-gateway/0011-nginx/policy.md` | `POL-0011` | policy | 01-gateway / 0011-nginx | active | AD-0001 | 3 / 2 | none found | `policies/0011-nginx.md` | move | V1 |
...
| `catalog/01-gateway/0013-traefik/policy.md` | `POL-0013` | policy | 01-gateway / 0013-traefik | active | AD-0001 | 3 / 2 | none found | `policies/0013-traefik.md` | move | V1 |
...
| `catalog/02-auth/0014-keycloak/policy.md` | `POL-0014` | policy | 02-auth / 0014-keycloak | active | AD-0002 | 3 / 2 | none found | `policies/0014-keycloak.md` | move | V1 |
...
| `catalog/02-auth/0015-oauth2-proxy/policy.md` | `POL-0015` | policy | 02-auth / 0015-oauth2-proxy | active | AD-0002 | 2 / 2 | none found | `policies/0015-oauth2-proxy.md` | move | V1 |
...
| `catalog/02-auth/0079-application-auth-integration/guide.md` | `GDE-0079` | guide | 02-auth / 0079-application-auth-integration | draft | POL-0079 | 8 / 7 | none found | `guides/0079-application-auth-integration.md` | move | V1 |
...
| `catalog/04-data/0025-cassandra/guide.md` | `GDE-0025` | guide | 04-data / 0025-cassandra | active | POL-0025 | 4 / 3 | none found | `guides/0025-cassandra.md` | move | V1 |
...
| `catalog/04-data/0025-cassandra/runbook.md` | `RUN-0025` | runbook | 04-data / 0025-cassandra | active | GDE-0025 | 4 / 3 | none found | `runbooks/0025-cassandra.md` | move | V1 |
| `catalog/04-data/0026-couchdb/guide.md` | `GDE-0026` | guide | 04-data / 0026-couchdb | active | POL-0026 | 4 / 3 | none found | `guides/0026-couchdb.md` | move | V1 |
...
| `catalog/04-data/0026-couchdb/runbook.md` | `RUN-0026` | runbook | 04-data / 0026-couchdb | active | GDE-0026 | 4 / 3 | none found | `runbooks/0026-couchdb.md` | move | V1 |
| `catalog/04-data/0027-mongodb/guide.md` | `GDE-0027` | guide | 04-data / 0027-mongodb | active | POL-0027 | 4 / 3 | none found | `guides/0027-mongodb.md` | move | V1 |
...
| `catalog/04-data/0027-mongodb/runbook.md` | `RUN-0027` | runbook | 04-data / 0027-mongodb | active | GDE-0027 | 4 / 3 | none found | `runbooks/0027-mongodb.md` | move | V1 |
...
| `catalog/04-data/0029-supabase/policy.md` | `POL-0029` | policy | 04-data / 0029-supabase | active | AD-0004 | 3 / 3 | none found | `policies/0029-supabase.md` | move | V1 |
...
| `catalog/04-data/0030-optimization-hardening/guide.md` | `GDE-0030` | guide | 04-data / 0030-optimization-hardening | active | POL-0030 | 2 / 1 | generic slug qualified by domain | `guides/0030-data-optimization-hardening.md` | move | V1 |
...
| `catalog/04-data/0031-postgresql-cluster/guide.md` | `GDE-0031` | guide | 04-data / 0031-postgresql-cluster | active | POL-0031 | 5 / 3 | none found | `guides/0031-postgresql-cluster.md` | move | V1 |
...
| `catalog/04-data/0031-postgresql-cluster/runbook.md` | `RUN-0031` | runbook | 04-data / 0031-postgresql-cluster | active | GDE-0031 | 6 / 3 | none found | `runbooks/0031-postgresql-cluster.md` | move | V1 |
...
| `catalog/04-data/0033-neo4j/guide.md` | `GDE-0033` | guide | 04-data / 0033-neo4j | active | POL-0033 | 4 / 3 | none found | `guides/0033-neo4j.md` | move | V1 |
...
| `catalog/04-data/0033-neo4j/runbook.md` | `RUN-0033` | runbook | 04-data / 0033-neo4j | active | GDE-0033 | 4 / 3 | none found | `runbooks/0033-neo4j.md` | move | V1 |
| `catalog/04-data/0034-qdrant/guide.md` | `GDE-0034` | guide | 04-data / 0034-qdrant | active | POL-0034 | 5 / 3 | none found | `guides/0034-qdrant.md` | move | V1 |
...
| `catalog/04-data/0034-qdrant/runbook.md` | `RUN-0034` | runbook | 04-data / 0034-qdrant | active | GDE-0034 | 5 / 4 | none found | `runbooks/0034-qdrant.md` | move | V1 |
...
| `catalog/05-messaging/0037-optimization-hardening/guide.md` | `GDE-0037` | guide | 05-messaging / 0037-optimization-hardening | active | POL-0037 | 2 / 2 | generic slug qualified by domain | `guides/0037-messaging-optimization-hardening.md` | move | V1 |
...
| `catalog/06-observability/0039-alertmanager/policy.md` | `POL-0039` | policy | 06-observability / 0039-alertmanager | active | AD-0006 | 3 / 3 | none found | `policies/0039-alertmanager.md` | move | V1 |
| `catalog/06-observability/0039-alertmanager/runbook.md` | `RUN-0039` | runbook | 06-observability / 0039-alertmanager | active | GDE-0039 | 4 / 4 | none found | `runbooks/0039-alertmanager.md` | move | V1 |
...
| `catalog/06-observability/0040-alloy/policy.md` | `POL-0040` | policy | 06-observability / 0040-alloy | active | AD-0006 | 4 / 3 | none found | `policies/0040-alloy.md` | move | V1 |
| `catalog/06-observability/0040-alloy/runbook.md` | `RUN-0040` | runbook | 06-observability / 0040-alloy | active | GDE-0040 | 5 / 3 | none found | `runbooks/0040-alloy.md` | move | V1 |
...
| `catalog/06-observability/0041-grafana/policy.md` | `POL-0041` | policy | 06-observability / 0041-grafana | active | AD-0006 | 3 / 3 | none found | `policies/0041-grafana.md` | move | V1 |
| `catalog/06-observability/0041-grafana/runbook.md` | `RUN-0041` | runbook | 06-observability / 0041-grafana | active | GDE-0041 | 4 / 3 | none found | `runbooks/0041-grafana.md` | move | V1 |
...
| `catalog/06-observability/0043-loki/policy.md` | `POL-0043` | policy | 06-observability / 0043-loki | active | AD-0006 | 4 / 3 | none found | `policies/0043-loki.md` | move | V1 |
| `catalog/06-observability/0043-loki/runbook.md` | `RUN-0043` | runbook | 06-observability / 0043-loki | active | GDE-0043 | 4 / 3 | none found | `runbooks/0043-loki.md` | move | V1 |
...
| `catalog/06-observability/0044-optimization-hardening/policy.md` | `POL-0044` | policy | 06-observability / 0044-optimization-hardening | active | AD-0006 | 3 / 2 | generic slug qualified by domain | `policies/0044-observability-optimization-hardening.md` | move | V1 |
...
| `catalog/06-observability/0045-prometheus/policy.md` | `POL-0045` | policy | 06-observability / 0045-prometheus | active | AD-0006 | 7 / 3 | none found | `policies/0045-prometheus.md` | move | V1 |
| `catalog/06-observability/0045-prometheus/runbook.md` | `RUN-0045` | runbook | 06-observability / 0045-prometheus | active | GDE-0045 | 5 / 3 | none found | `runbooks/0045-prometheus.md` | move | V1 |
...
| `catalog/06-observability/0046-pushgateway/policy.md` | `POL-0046` | policy | 06-observability / 0046-pushgateway | active | AD-0006 | 3 / 3 | none found | `policies/0046-pushgateway.md` | move | V1 |
...
| `catalog/06-observability/0047-pyroscope/policy.md` | `POL-0047` | policy | 06-observability / 0047-pyroscope | active | AD-0006 | 4 / 3 | none found | `policies/0047-pyroscope.md` | move | V1 |
| `catalog/06-observability/0047-pyroscope/runbook.md` | `RUN-0047` | runbook | 06-observability / 0047-pyroscope | active | GDE-0047 | 4 / 3 | none found | `runbooks/0047-pyroscope.md` | move | V1 |
| `catalog/06-observability/0048-telemetry-retention/policy.md` | `POL-0048` | policy | 06-observability / 0048-telemetry-retention | active | AD-0006 | 5 / 0 | none found | `policies/0048-telemetry-retention.md` | move | V1 |
...
| `catalog/06-observability/0049-tempo/policy.md` | `POL-0049` | policy | 06-observability / 0049-tempo | active | AD-0006 | 4 / 3 | none found | `policies/0049-tempo.md` | move | V1 |
| `catalog/06-observability/0049-tempo/runbook.md` | `RUN-0049` | runbook | 06-observability / 0049-tempo | active | GDE-0049 | 5 / 3 | none found | `runbooks/0049-tempo.md` | move | V1 |
...
| `catalog/07-workflow/0050-airflow/policy.md` | `POL-0050` | policy | 07-workflow / 0050-airflow | active | AD-0007 | 4 / 3 | none found | `policies/0050-airflow.md` | move | V1 |
| `catalog/07-workflow/0050-airflow/runbook.md` | `RUN-0050` | runbook | 07-workflow / 0050-airflow | active | GDE-0050 | 8 / 6 | none found | `runbooks/0050-airflow.md` | move | V1 |
...
| `catalog/07-workflow/0053-n8n/policy.md` | `POL-0053` | policy | 07-workflow / 0053-n8n | active | AD-0007 | 4 / 3 | none found | `policies/0053-n8n.md` | move | V1 |
| `catalog/07-workflow/0053-n8n/runbook.md` | `RUN-0053` | runbook | 07-workflow / 0053-n8n | active | GDE-0053 | 5 / 5 | none found | `runbooks/0053-n8n.md` | move | V1 |
...
| `catalog/07-workflow/0054-optimization-hardening/policy.md` | `POL-0054` | policy | 07-workflow / 0054-optimization-hardening | active | AD-0007 | 2 / 2 | generic slug qualified by domain | `policies/0054-workflow-optimization-hardening.md` | move | V1 |
...
| `catalog/08-ai/0056-ollama/guide.md` | `GDE-0056` | guide | 08-ai / 0056-ollama | active | POL-0056 | 6 / 3 | none found | `guides/0056-ollama.md` | move | V1 |
| `catalog/08-ai/0056-ollama/policy.md` | `POL-0056` | policy | 08-ai / 0056-ollama | active | AD-0008 | 4 / 3 | none found | `policies/0056-ollama.md` | move | V1 |
| `catalog/08-ai/0056-ollama/runbook.md` | `RUN-0056` | runbook | 08-ai / 0056-ollama | active | GDE-0056 | 5 / 5 | none found | `runbooks/0056-ollama.md` | move | V1 |
...
| `catalog/08-ai/0057-open-webui/policy.md` | `POL-0057` | policy | 08-ai / 0057-open-webui | active | AD-0008 | 4 / 3 | none found | `policies/0057-open-webui.md` | move | V1 |
| `catalog/08-ai/0057-open-webui/runbook.md` | `RUN-0057` | runbook | 08-ai / 0057-open-webui | active | GDE-0057 | 6 / 5 | none found | `runbooks/0057-open-webui.md` | move | V1 |
...
| `catalog/08-ai/0058-optimization-hardening/policy.md` | `POL-0058` | policy | 08-ai / 0058-optimization-hardening | active | AD-0008 | 2 / 2 | generic slug qualified by domain | `policies/0058-ai-optimization-hardening.md` | move | V1 |
| `catalog/08-ai/0058-optimization-hardening/runbook.md` | `RUN-0058` | runbook | 08-ai / 0058-optimization-hardening | active | GDE-0058 | 2 / 2 | generic slug qualified by domain | `runbooks/0058-ai-optimization-hardening.md` | move | V1 |
...
| `catalog/09-tooling/0060-iac-deployment/policy.md` | `POL-0060` | policy | 09-tooling / 0060-iac-deployment | active | AD-0009 | 1 / 0 | none found | `policies/0060-iac-deployment.md` | move | V1 |
...
| `catalog/09-tooling/0061-k6/policy.md` | `POL-0061` | policy | 09-tooling / 0061-k6 | active | AD-0009 | 3 / 1 | none found | `policies/0061-k6.md` | move | V1 |
...
| `catalog/09-tooling/0063-optimization-hardening/policy.md` | `POL-0063` | policy | 09-tooling / 0063-optimization-hardening | active | AD-0009 | 2 / 2 | generic slug qualified by domain | `policies/0063-tooling-optimization-hardening.md` | move | V1 |
...
| `catalog/09-tooling/0083-renovate/guide.md` | `GDE-0083` | guide | 09-tooling / 0083-renovate | draft | POL-0083 | 4 / 0 | none found | `guides/0083-renovate.md` | move | V1 |
| `catalog/09-tooling/0083-renovate/policy.md` | `POL-0083` | policy | 09-tooling / 0083-renovate | draft | AD-0009 | 2 / 2 | none found | `policies/0083-renovate.md` | move | V1 |
...
| `catalog/11-laboratory/0074-optimization-hardening/policy.md` | `POL-0074` | policy | 11-laboratory / 0074-optimization-hardening | active | AD-0011 | 2 / 2 | generic slug qualified by domain | `policies/0074-laboratory-optimization-hardening.md` | move | V1 |
| `catalog/11-laboratory/0074-optimization-hardening/runbook.md` | `RUN-0074` | runbook | 11-laboratory / 0074-optimization-hardening | active | GDE-0074 | 2 / 2 | generic slug qualified by domain | `runbooks/0074-laboratory-optimization-hardening.md` | move | V1 |
...
| `catalog/12-infra-net/0077-ip-address-management/policy.md` | `POL-0077` | policy | 12-infra-net / 0077-ip-address-management | active | AD-0026 | 2 / 2 | none found | `policies/0077-ip-address-management.md` | move | V1 |
| `catalog/12-infra-net/0077-ip-address-management/runbook.md` | `RUN-0077` | runbook | 12-infra-net / 0077-ip-address-management | active | GDE-0077 | 2 / 2 | none found | `runbooks/0077-ip-address-management.md` | move | V1 |
