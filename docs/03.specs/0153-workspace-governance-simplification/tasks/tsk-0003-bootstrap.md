...
| Native package activation | The legacy `0153-workspace-governance-simplification` package was moved to `docs/03.specs/0153-workspace-governance-simplification/` without a redirect or compatibility copy. |
...
| Reciprocal predecessor relation | `SPEC-0153` supersedes `SPEC-0136`; `docs/03.specs/0136-sdlc-taxonomy-convergence/spec.md` is marked `status: superseded` with `superseded_by: SPEC-0153`. |
...
| Link traceability | `python3 scripts/validation/check-document-links.py --mode traceability` | Returned baseline `document-not-regular` for `docs/03.specs/0137-agentic-research-pack-rebuild/tasks/tsk-0001-rebuild.md`; reproduced from the main working root and not counted as a Task 3 PASS. |
