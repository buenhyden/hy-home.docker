...
| Fix-round-3 Stage 03 evidence | Exact unchanged historical evidence, mutated evidence, and active `spec-9999-current/spec.md` | PASS: only the exact path/digest evidence is allowed; both mutations produce `AGC-UNSUPPORTED-TOKEN`. |
