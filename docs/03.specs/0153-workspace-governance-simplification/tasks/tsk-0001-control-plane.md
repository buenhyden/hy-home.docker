...
# Task 0001: Register the Governance Control Plane

## Objective

This Task records the completed cross-stage authority decision, exact approved
migration selection, and control-plane validation evidence created by Plan
Task 1.
...
- Record actual RED/GREEN evidence without prospectively approving or executing
  any transition.
- Do not move or delete a corpus path, change provider surfaces, push, merge,
  or change runtime state. Task 1 did not modify validators.

## Scope and Change Boundaries

The allowed Task 1 paths were the ADR, Migration, bootstrap Task, focused test,
and bounded Spec/Plan evidence. All corpus transitions, provider surfaces,
unlisted scripts, runtime, remote, and secret surfaces were excluded.
...
The original combined bootstrap evidence is recoverable as Git blob
`f271bcf127e2ad766b6006210e9cba1d41176887` with SHA-256
`1fc246c7b23a9d998939d1f40ae1af82fc41f7aed151ae3a1b162bbb9d2010ba`.
Task 1 Work Log, Verification, Review, Approval, and Commit fields are retained
in this record; Task 2 fields are retained in `tsk-0002-stage99.md`.
...
- `71f89ba1` — `docs: record governance migration commit`

## Rulings

- Migration schema version 2 distinguishes tracked sources from planned
  outputs and keeps recovery binding deferred until final compaction.

## Deferred Items

- Task 1 is complete; later Tasks may execute only their approved Migration rows.
