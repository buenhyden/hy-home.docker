<!-- Target: docs/03.specs/098-standardize-infra-net/README.md -->
...
`docs/03.specs/098-standardize-infra-net`는 Docker 네트워크 이름, 브리지/외부 네트워크 경계, 서비스 간 통신 패턴 표준화 사양을 포함합니다.
