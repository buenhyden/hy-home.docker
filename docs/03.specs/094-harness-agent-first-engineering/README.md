<!-- Target: docs/03.specs/094-harness-agent-first-engineering/README.md -->
...
`docs/03.specs/094-harness-agent-first-engineering`는 Claude/Codex 런타임 하네스, 훅 이벤트 디스패처, 에이전트 카탈로그, 스킬 시스템 설계 사양을 포함합니다.
