...
updated: 2026-08-11
---
<!-- Target: docs/03.specs/spec-0009-ai/spec.md -->
...
- Conversation/RAG data retention policy is controlled by the operations policy document (`docs/05.operations/08-ai/ops-0058-optimization-hardening/policy.md`).
...
- **Policy**: [../../05.operations/policies/08-ai/optimization-hardening.md](../../05.operations/08-ai/ops-0058-optimization-hardening/policy.md)
...
- **Guide**: [../../05.operations/guides/08-ai/open-webui.md](../../05.operations/08-ai/ops-0057-open-webui/guide.md)
- **Policy**: [../../05.operations/policies/08-ai/open-webui.md](../../05.operations/08-ai/ops-0057-open-webui/policy.md)
- **Runbook**: [../../05.operations/runbooks/08-ai/open-webui.md](../../05.operations/08-ai/ops-0057-open-webui/runbook.md)
