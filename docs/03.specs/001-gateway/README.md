<!-- README Target: docs/03.specs/001-gateway/README.md -->
...
`docs/03.specs/001-gateway`는 root-active Traefik edge router와 profile-only Nginx path proxy leaf의 기술 사양을 포함합니다.
