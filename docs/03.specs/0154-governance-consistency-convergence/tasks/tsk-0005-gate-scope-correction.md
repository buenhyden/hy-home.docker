...
still listing a Stage 04 plans directory and its tasks directory in its
structure block, routing table, and language table, plus a requirements
subdirectory under Stage 02 and three subdirectories under Stage 05 for guides,
policies, and runbooks, none of which exist. Two
...
3. **Two Spec acceptance items were wrong proxies and were corrected, not
   ...
   asks that no active document _describe Stage 04 as current procedure_, which
