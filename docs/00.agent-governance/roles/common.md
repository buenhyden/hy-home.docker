...
- **Standards**: Priority on Clean Code, SOLID principles, and `docs/00.agent-governance/policies/quality-standards.md`.
...
@import docs/00.agent-governance/roles/common.md
