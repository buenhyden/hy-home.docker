...
- **Stack**: **LGTM** (Loki, Grafana, Tempo, Prometheus) plus Alloy, Alertmanager, Pushgateway, cAdvisor, and Pyroscope.
- **Criteria**: Mandatory alignment with `docs/00.agent-governance/policies/quality-standards.md`.
...
- **Post-mortems**: Mandatory retrospective as `postmortem.md` inside the incident packet folder for any SEV1/SEV2 incident.
...
@import docs/00.agent-governance/roles/ops.md
...
- [Bootstrap rule](../policies/bootstrap.md)
- [Persona protocol](../policies/persona.md)
- [Task checklists](../policies/task-checklists.md)
- [Agentic rule](../policies/agentic.md)
