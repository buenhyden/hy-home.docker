...
- Governance: follow `docs/00.agent-governance/policies/quality-standards.md`.
...
2. Run security checks defined in active scope plus `policies/task-checklists.md`.
