...
- **Criteria**: Mandatory compliance with `docs/00.agent-governance/policies/quality-standards.md`.
...
@import docs/00.agent-governance/roles/qa.md
...
- [Postflight checklist](../policies/postflight-checklist.md)
