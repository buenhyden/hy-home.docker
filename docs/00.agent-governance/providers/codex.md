...
- `.codex/agents/` and `.codex/skills/` act as an adapter surface for Codex under the Adapter Model (`providers/agents-md.md` §5). They align with the common catalog in `docs/00.agent-governance/agents/`.
