...
- **Human-First Docs** (`docs/01.prd - 11.postmortems`): Written primarily in **Korean** to ensure stakeholder alignment. Technical terms and code-level references stay in English.
