...
| Architecture | `descriptions/ad-<id>-<slug>.md` and `decisions/adr-<id>-<slug>.md` | Architecture Description and ADR |
| Capability | `docs/03.specs/spec-<id>-<slug>/{spec,plan,task}.md` | Spec, Plan, Task |
| Operations | `docs/05.operations/<domain>/ops-<id>-<subject>/{guide,policy,runbook}.md` | Operations role templates |
| Event records | `inc-<id>-<slug>` and `rel-<id>-<slug>` directories | Incident, Postmortem, Release |
...
| `docs/05.operations/*/ops-*/guide.md`            | Korean human-facing usage guidance; preserve commands, paths, identifiers, and service names                        |
| `docs/05.operations/*/ops-*/policy.md`           | Korean human-facing controls; preserve control names, evidence IDs, and technical identifiers                       |
| `docs/05.operations/*/ops-*/runbook.md`          | Korean human-facing procedures; preserve commands, expected output names, and escalation evidence                   |
...
| `docs/98.archive/**`                             | Concise tombstone language; preserve original paths, IDs, dates, titles, and profile-admitted replacement links     |
...
| :------------- | :----------------------------------------- | :-------------------------------------------- |
| `incident`     | `docs/05.operations/incidents/inc-<id>-<slug>/incident.md` | A recorded production incident                |
| `postmortem`   | `docs/05.operations/incidents/inc-<id>-<slug>/postmortem.md` | A reviewed incident                           |
| `release`      | `docs/05.operations/releases/rel-<id>-<slug>/release.md` | A tagged release                              |
| `api-spec`     | `docs/03.specs/spec-<id>-<capability>/api-spec.md`     | A specification defining an HTTP or RPC API   |
| `data-model`   | `docs/03.specs/spec-<id>-<capability>/data-model.md`   | A specification defining persisted entities   |
| `service`      | `docs/03.specs/spec-<id>-<capability>/service.md`      | A specification introducing a Compose service |
| `tests`        | `docs/03.specs/spec-<id>-<capability>/tests.md`        | A specification with a formal test matrix     |
| `agent-design` | `docs/03.specs/spec-<id>-<capability>/agent-design.md` | A specification defining a new agent role     |
