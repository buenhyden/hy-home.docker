...
| 03 specifications            | Technical specifications           | Before implementation tasks start                                    | Backend/Frontend/Infra Engineer                        | PRD, ARD, ADR                                                         | Spec docs and optional contracts                                 | `docs/99.templates/spec.template.md`, `api-spec.template.md`, `agent-design.template.md`, `data-model.template.md`, `tests.template.md`, and machine-readable contract templates                                       | Interfaces, data contracts, and verification criteria are complete                                                                                      |
