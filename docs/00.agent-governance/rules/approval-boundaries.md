...
| `docs/00.agent-governance/**`              | Governance SSOT                   | Policy text, agent/skill catalog, or provider parity change     | `validate-harness.sh`                                                  | PR + Stage 04 Task + bounded `memory/current.md` handoff | `git revert`                  |
