...
**Overview (KR):** 모든 컨테이너 서비스에 대해 메모리 및 CPU 리소스 제한을 강제하여 시스템 안정성을 보장합니다.
...
- **Related Specs**: [System Optimization Spec](../specs/2026-02-26-infra-system-optimization-spec.md)
