...
parent_ids: []
archived_from: docs/04.execution/plans/2026-07-03-workspace-document-contract-audit-pack.md
archived_at: 2026-08-11
archive_reason: "Move baseline completed source to stable typed target docs/98.archive/changes/chg-0066-workspace-document-contract-audit-pack/plan.md; migrate 7 resolved inbound link(s) with it."
archive_disposition: evidence-preserve
archived_commit: 232effd9a5e00907bdbe30efc6665023fb2d07f4
archived_blob: a606492a10fba5de3effe2a4684d350e693ebd57
...
- **Spec**: [Workspace document contract audit pack spec](../../../03.specs/spec-0102-workspace-document-contract-audit-pack/spec.md)
- **Task Evidence**: [Workspace document contract audit pack task](task.md)
