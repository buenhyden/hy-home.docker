...
parent_ids: []
archived_from: docs/04.execution/tasks/2026-06-02-agent-governance-missing-items-implementation.md
archived_at: 2026-08-11
archive_reason: "Move baseline completed source to stable typed target docs/98.archive/changes/chg-0115-agent-governance-missing-items-implementation/task.md; migrate 28 resolved inbound link(s) with it."
archive_disposition: evidence-preserve
archived_commit: 232effd9a5e00907bdbe30efc6665023fb2d07f4
archived_blob: 40eddd2eb01050c60761bd036c691e719140c4bc
...
- **Parent Plan**: [Agent Governance Decision Items Implementation Plan](../chg-0055-agent-governance-decision-items/plan.md)
...
- **Test Commands**:
  ...
  - `bash scripts/knowledge/generate-llm-wiki-index.sh` — regenerated `docs/90.references/llm-wiki/llm-wiki-index.md` with 1029 paths after fresh revalidation.
  ...
  - `bash scripts/knowledge/generate-llm-wiki-index.sh` after approved gate closure — regenerated `docs/90.references/llm-wiki/llm-wiki-index.md` with 1014 paths.
