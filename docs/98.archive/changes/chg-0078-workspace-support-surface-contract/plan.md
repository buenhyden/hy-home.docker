...
parent_ids: []
archived_from: docs/04.execution/plans/2026-07-05-workspace-support-surface-contract.md
archived_at: 2026-08-11
archive_reason: "Move baseline completed source to stable typed target docs/98.archive/changes/chg-0078-workspace-support-surface-contract/plan.md; migrate 6 resolved inbound link(s) with it."
archive_disposition: evidence-preserve
archived_commit: 232effd9a5e00907bdbe30efc6665023fb2d07f4
archived_blob: b0ca153694d8d91c83a9c093567e151ae6df2a4e
...
- **Spec**: [Workspace Support Surface Contract Spec](../../tombstones/03.specs/spec-0106-workspace-support-surface-contract.md)
- **Task**: [Workspace Support Surface Contract Task](task.md)
