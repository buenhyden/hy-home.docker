...
parent_ids: []
archived_from: docs/04.execution/plans/2026-04-10-infra-team-agent-cross-validation.md
archived_at: 2026-08-11
archive_reason: "Move baseline completed source to stable typed target docs/98.archive/changes/chg-0026-infra-team-agent-cross-validation/plan.md; migrate 12 resolved inbound link(s) with it."
archive_disposition: evidence-preserve
archived_commit: 232effd9a5e00907bdbe30efc6665023fb2d07f4
archived_blob: 69d09ba8cb7f869993a0de214f19310218643e55
...
This document is the implementation plan for settling the team-agent cross-validation design that runs immediately after infra changes into canonical stage paths. It migrates the existing `docs/superpowers` content into `docs/03.specs/008-workflow/agent-design.md` and this plan document, while also tightening local governance rules to prevent nonstandard path recurrence.
...
- **Goals**:
- `DOC-AGT-001`: Keep the active agent design document only at `docs/03.specs/008-workflow/agent-design.md`.
...
| --- | --- | --- | --- | --- |
| PLN-001 | Rewrite `docs/superpowers` spec content into a template-based canonical agent design | `docs/03.specs/008-workflow/agent-design.md`, `docs/03.specs/008-workflow/spec.md` | `DOC-AGT-001` | New agent design includes required sections and `## Related Documents`. |
...
| --- | --- | --- | --- | --- |
| VAL-PLN-001 | Structural | canonical agent design exists in the stage path | `test -f docs/03.specs/008-workflow/agent-design.md` | exit code 0 |
...
| VAL-PLN-003 | Content | changed docs include required related-doc sections | `rg -n "^## Related Documents" AGENTS.md docs/00.agent-governance/scopes/docs.md docs/00.agent-governance/rules/documentation-protocol.md docs/03.specs/008-workflow/agent-design.md docs/04.execution/plans/2026-04-10-infra-team-agent-cross-validation.md` | every changed doc matched |
...
- [x] Canonical `agent-design.md` created under `docs/03.specs/008-workflow/`
...
- **Spec**: [../03.specs/008-workflow/agent-design.md](../../../03.specs/spec-0008-workflow/spec.md)
- **Task**: [Infra team agent cross-validation task](task.md)
- **Workflow Parent Spec**: [../03.specs/008-workflow/spec.md](../../../03.specs/spec-0008-workflow/spec.md)
- **PRD Context**: [../01.requirements/prd-0019-workflow-optimization-hardening.md](../../../01.requirements/prd-0019-workflow-optimization-hardening.md)
