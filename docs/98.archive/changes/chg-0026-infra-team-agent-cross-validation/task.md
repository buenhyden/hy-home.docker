...
parent_ids: []
archived_from: docs/04.execution/tasks/2026-04-10-infra-team-agent-cross-validation.md
archived_at: 2026-08-11
archive_reason: "Move baseline completed source to stable typed target docs/98.archive/changes/chg-0026-infra-team-agent-cross-validation/task.md; migrate 10 resolved inbound link(s) with it."
archive_disposition: evidence-preserve
archived_commit: 232effd9a5e00907bdbe30efc6665023fb2d07f4
archived_blob: cbc05ecbef1be03e709412ef7477fe23f268af35
...
- **Parent Spec**: [Workflow cross-validation agent design](../../../03.specs/spec-0008-workflow/spec.md)
- **Parent Plan**: [Infra team agent cross-validation plan](plan.md)
...
- **Parent Spec**: [Workflow cross-validation agent design](../../../03.specs/spec-0008-workflow/spec.md)
- **Parent Plan**: [Infra team agent cross-validation plan](plan.md)
- **Workflow Spec**: [Workflow spec](../../../03.specs/spec-0008-workflow/spec.md)
- **Subagent Protocol**: [Subagent protocol](../../../00.agent-governance/subagent-protocol.md)
- **Agent Catalog**: [Agent and function catalog](../../../00.agent-governance/agents/README.md)
