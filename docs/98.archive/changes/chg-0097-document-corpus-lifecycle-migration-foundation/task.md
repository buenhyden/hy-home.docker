...
parent_ids: []
archived_from: docs/04.execution/tasks/2026-07-14-document-corpus-lifecycle-migration-foundation.md
archived_at: 2026-08-11
archive_reason: "Move baseline completed source to stable typed target docs/98.archive/changes/chg-0097-document-corpus-lifecycle-migration-foundation/task.md; migrate 6 resolved inbound link(s) with it."
archive_disposition: evidence-preserve
archived_commit: 232effd9a5e00907bdbe30efc6665023fb2d07f4
archived_blob: 6377f23748e4583d6bb4ffa16b10121d5a86098a
...
- [Stage 04 Tasks](../../../03.specs/README.md)
