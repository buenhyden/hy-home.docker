...
| DOC-005 | Docs Lifecycle | `docs/05.operations/guides/00-workspace/developer-setup.md` | Overview referenced pre-consolidation guide path | Target text path stale | Confusing guide identity | Updated to current guide path | Low | T-WAI-006 | Repo contract PASS | Closed |
