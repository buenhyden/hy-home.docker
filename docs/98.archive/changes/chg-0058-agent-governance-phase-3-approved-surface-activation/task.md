...
parent_ids: []
archived_from: docs/04.execution/tasks/2026-06-02-agent-governance-phase-3-approved-surface-activation.md
archived_at: 2026-08-11
archive_reason: "Move baseline completed source to stable typed target docs/98.archive/changes/chg-0058-agent-governance-phase-3-approved-surface-activation/task.md; migrate 7 resolved inbound link(s) with it."
archive_disposition: evidence-preserve
archived_commit: 232effd9a5e00907bdbe30efc6665023fb2d07f4
archived_blob: e9cde6f6782957ab427f0926ed1d1a7325812d9d
...
- **Parent Plan**: [Agent Governance Phase 3 Approved Surface Activation Plan](plan.md)
...
- **Test Commands**:
  ...
  - `bash scripts/knowledge/generate-llm-wiki-index.sh` — regenerated `docs/90.references/llm-wiki/llm-wiki-index.md` with 1028 paths after staging the new Phase 3 Stage 04 artifacts.
