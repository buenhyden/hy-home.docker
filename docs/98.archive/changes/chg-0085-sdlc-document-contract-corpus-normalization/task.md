...
parent_ids: []
archived_from: docs/04.execution/tasks/2026-07-06-sdlc-document-contract-corpus-normalization.md
archived_at: 2026-08-11
archive_reason: "Move baseline completed source to stable typed target docs/98.archive/changes/chg-0085-sdlc-document-contract-corpus-normalization/task.md; migrate 3 resolved inbound link(s) with it."
archive_disposition: evidence-preserve
archived_commit: 232effd9a5e00907bdbe30efc6665023fb2d07f4
archived_blob: ca34b4601e034c7ec8a6731fae6ac15f05c37194
...
- **Parent Spec**: [SDLC document contract corpus normalization spec](../../tombstones/03.specs/spec-0119-sdlc-document-contract-corpus-normalization.md)
- **Parent Plan**: [SDLC document contract corpus normalization plan](plan.md)
