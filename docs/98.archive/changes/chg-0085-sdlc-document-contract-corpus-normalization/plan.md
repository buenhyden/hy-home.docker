...
parent_ids: []
archived_from: docs/04.execution/plans/2026-07-06-sdlc-document-contract-corpus-normalization.md
archived_at: 2026-08-11
archive_reason: "Move baseline completed source to stable typed target docs/98.archive/changes/chg-0085-sdlc-document-contract-corpus-normalization/plan.md; migrate 4 resolved inbound link(s) with it."
archive_disposition: evidence-preserve
archived_commit: 232effd9a5e00907bdbe30efc6665023fb2d07f4
archived_blob: a4815927ec6d0a67d7c28267a6752357b7601ea7
...
- **Spec**: [../../98.archive/03.specs/119-sdlc-document-contract-corpus-normalization/spec.md](../../tombstones/03.specs/spec-0119-sdlc-document-contract-corpus-normalization.md)
- **Task**: [../tasks/2026-07-06-sdlc-document-contract-corpus-normalization.md](task.md)
- **Numbered path migration spec**: [../../98.archive/03.specs/099-template-system-numbered-sdlc-paths/spec.md](../../tombstones/03.specs/spec-0099-template-system-numbered-sdlc-paths.md)
- **Document restructure disposition spec**: [../../03.specs/103-document-restructure-audit-contract-archive/spec.md](../../../03.specs/spec-0103-document-restructure-audit-contract-archive/spec.md)
