...
parent_ids: []
archived_from: docs/04.execution/tasks/2026-07-02-template-system-reorganization.md
archived_at: 2026-08-11
archive_reason: "Move baseline completed source to stable typed target docs/98.archive/changes/chg-0063-template-system-reorganization/task.md; migrate 2 resolved inbound link(s) with it."
archive_disposition: evidence-preserve
archived_commit: 232effd9a5e00907bdbe30efc6665023fb2d07f4
archived_blob: de71ee27130c6d9f248bbfa6817baefc72927b17
...
- **Parent Spec**: [Template system reorganization spec](../../tombstones/03.specs/spec-0101-template-system-reorganization.md)
- **Parent Plan**: [Template system reorganization plan](plan.md)
