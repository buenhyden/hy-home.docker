...
parent_ids: []
archived_from: docs/04.execution/tasks/2026-07-18-target-surface-contract-convergence.md
archived_at: 2026-08-11
archive_reason: "Move baseline completed source to stable typed target docs/98.archive/changes/chg-0099-target-surface-contract-convergence/task.md; migrate 4 resolved inbound link(s) with it."
archive_disposition: evidence-preserve
archived_commit: 232effd9a5e00907bdbe30efc6665023fb2d07f4
archived_blob: 676dda82b2374e8a0656e11e3f601e270bec0d2a
...
| --- | --- | --- |
| T-TSC-001 | Archive, metadata, wave, and manifest foundation | complete |
| T-TSC-002 | README, typed example, and Storybook cleanup | complete |
| T-TSC-003 | Root content archive provenance migration | complete |
...
| T-TSC-006 | Research, audit, generated evidence, and closure | complete |
...
| 2026-07-19 | T-TSC-006 post-promotion controlled wrapper | Controller | Re-ran the approved wrapper from clean real HEAD `b66cdff42317a9b1249d6331a6679d8e7bb88e79` with the exact 12 bounded prefixes. Hook exit 0 and snapshot PASS; before, after, changed, and unexpected path counts were all 0 and every path set was `(none)`. No formatter mutation occurred. |
...
| 2026-07-19 | T-TSC-005 terminal reviews and implementation identity | Independent specification and quality reviewers; Controller | Final specification PASS C0/I0/M0 and quality APPROVED C0/I0/M0 cover synthetic review range `3dcd8c32063f4d18cf2b29123d0ddfd436e3cb57..264d58e25c2ce047d06059340420442c020c6c06`. Actual implementation commit is `e11cb231c001f01937177108a42599466fa4f644`. Task 5 is complete and Task 6 may proceed. Aggregate `failures=6` remains explicitly environment/Task 6-owned and is not recorded as passing. |

## Verification Evidence

| Work unit | RED evidence | GREEN/aggregate evidence | Result |
| --- | --- | --- | --- |
| T-TSC-001 | Metadata RED: 76 tests, 7 failures/5 errors; lifecycle RED: 38 tests, 11 failures/4 errors; first specification-fix mutation RED: 4/4 expected failures plus one human-contract test with four expected assertion failures; exceptional validator RED: two tests produced five expected subcase failures; archive-contract RED: one focused human-owner test exited 1 because the two exact profile sections were absent; final-review fixture RED: 11 tests with four failures across three methods; CLI-shape RED: full lifecycle 101/103; typed-target correction RED: three focused methods emitted six expected failures across missing human semantics, the truthful migrated target, and the null after-type mutation; fail-closed re-review RED: five focused methods failed 0/5 at the target parse/profile/read/native-body boundaries; foundation-quality aggregate RED: 0/2 with `content-archive` the sole missing role. All RED preceded the corresponding production, contract, or test-boundary change. | Fail-closed correction passed focused 5/5, full lifecycle 111/111, focused metadata 76/76, target 9/9, and all prescribed gates. Quality remediation passed aggregate 2/2 and full metadata 218/218. Final foundation specification PASS C0/I0/M0 covers `820e6188307ead1478de200f75a2d08e62ac137a..dd53a695e6893265a8d72c1810f334a6de5daa95`; final quality APPROVED C0/I0/M0 covers `820e6188307ead1478de200f75a2d08e62ac137a..4cac2af5d7508abd2b9722ee2c6a2d4f01ba7899`. The later blocking promotion passes all 483 row verdict pairs. | complete |
| T-TSC-002 | Initial target suite RED: 8 tests ran with eight expected failure records across stale Service metadata/sections/instruction text and five active phantom references. I-01 remediation RED: the focused manifest/document regression failed 1/1 with target `spec:sample-web-service`/`spec`/one parent versus manifest null/null/empty. Fail-closed re-review RED: five methods failed exactly five assertions. | README profiles 4/4, target suite 9/9, fail-closed focus 5/5, and full lifecycle 111/111. Final specification PASS C0/I0/M0 and quality APPROVED C0/I0/M0 each cover `f037630ddeef4e7cc738dd9489b9218c452510ae..dd53a695e6893265a8d72c1810f334a6de5daa95`. The blocking promotion retains the reviewed migrations and passes all 483 row verdict pairs. | complete |
| T-TSC-003 | Initial and remediation RED evidence remains recorded below, including the payload-free final-exception unordered and ordered list subcases. | Final-exception GREEN passed listed/bare/current 3/3, `ArchiveProvenanceTests` 8/8, and full lifecycle 114/114. Terminal specification PASS C0/I0/M0 and quality APPROVED C0/I0/M0 each cover exact range `8076a1270023226bedd25721928f12870dc559f5..7315677e339f175cfdc4c53411fa881227ffb7a0`. Terminal evidence sync passed metadata 2/0, traceability 46/0, focused contracts 9/9, manifest/summary, and diff hygiene. The blocking promotion preserves the reviewed tombstone identity and passes all row verdicts. | complete |
| T-TSC-004 | OpenSearch and SeaweedFS duplicate RED/evidence reviews are recorded in the Work Log; exact reviews returned PASS/APPROVED C0/I0/M0. | InfluxDB, OpenSearch, and SeaweedFS disposition/evidence commits are immutable. After the later corpus-wide promotion, manifest/summary report 483 pass/pass rows: 3 delete, 10 migrate, and 470 preserve. Direct manifest/static, summary, promoted, target, and static Compose checks have zero findings. SeaweedFS activation remains a separate runtime/security chain. | complete |
...
| T-TSC-006 | Promotion contract RED first failed because the canonical target wave was advisory; blocking then exposed exactly four stale target attestations and three generated-owner disposition mismatches. | Seven research leaves and eight audit leaves are reconciled; all fixed-order owners are fresh; full validation and the static ladder pass; Task 6, promotion, and final whole-branch reviews pass; both controlled-wrapper executions pass without mutation. The fail-closed promotion correction changes only enforcement, 480 verdict pairs, four target attestations, and three generated-owner dispositions. The blocking manifest has 483 pass/pass rows with 3 delete, 10 migrate, and 470 preserve. | complete |
...
Terminal independent reviews cover synthetic range
`3dcd8c32063f4d18cf2b29123d0ddfd436e3cb57..264d58e25c2ce047d06059340420442c020c6c06`:
specification PASS C0/I0/M0 and quality APPROVED C0/I0/M0. The actual
implementation commit is `e11cb231c001f01937177108a42599466fa4f644`.
Task 5 is complete and Task 6 may proceed. The recorded aggregate
`failures=6` remains one missing environment dependency plus five Task 6 or
baseline freshness failures; it is not promoted to a passing result.
...
| T-TSC-004b SeaweedFS | `refactor(infra): remove inactive SeaweedFS security config` | `f50fdd2670404f9ad32bdf9a6aa1e0ffb5ff6d0f` | Exact duplicate specification PASS and quality APPROVED C0/I0/M0; retained `.example` is unmounted. |
| T-TSC-004b SeaweedFS evidence | `fix(infra): align SeaweedFS duplicate evidence` | `49c4db893a4b53ac6b0e8a4dfe4e76d81c16ddc2` | Exact evidence specification PASS and quality APPROVED C0/I0/M0; row promoted pass/pass and summary reports 3/7/473 with 3/480 verdicts. |
| T-TSC-005 | `feat(qa): enforce target surface contracts` | `e11cb231c001f01937177108a42599466fa4f644` | Artifact RED 1 method/2 failures and GREEN 1/1; target 35/35, CI 23/23, wrapper 29/29; terminal specification PASS and quality APPROVED C0/I0/M0 over the recorded synthetic range. Aggregate `failures=6` remains Task 6/environment-owned. |
| T-TSC-006 research | `docs(research): reconcile target surface evidence` | `86bf27d9` | Seven research and eight audit canonical leaves reconciled; subsequent independent Task 6 and whole-branch reviews passed. |
| T-TSC-006 generated owners | `docs(evidence): refresh target surface generated owners` | `ef7eb4b1` | Fixed-order generated owners passed their freshness checks. |
| T-TSC-006 semantic fixture | `test(governance): keep semantic workflow fixture current` | `2a79c97f` | Focused semantic suite passed 32/32; full discovery subsequently passed 660/660. |
| T-TSC-006 evidence candidate | `docs(execution): record task 6 evidence candidate` | `c1e086a1` | Task 6 and pre-promotion whole-branch specification/quality reviews returned C0/I0/M0. |
...
- SeaweedFS security scaffold activation remains a separate approved runtime
  and security chain.
- The inactive SeaweedFS `config/security.toml` deletion and direct README,
  guide, and policy alignment are complete. Task 6 still owns only the canonical
  generated fallout and closure evidence. Activating the retained `.example`
  remains a separately approved runtime/security task.
...
- [Spec 133](../../../03.specs/spec-0133-target-surface-contract-convergence/spec.md)
- [Implementation Plan](plan.md)
- [Spec 131](../../../03.specs/spec-0131-document-corpus-lifecycle-migration-foundation/spec.md)
