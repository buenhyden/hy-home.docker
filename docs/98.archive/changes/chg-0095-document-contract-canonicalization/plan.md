...
parent_ids: []
archived_from: docs/04.execution/plans/2026-07-13-document-contract-canonicalization.md
archived_at: 2026-08-11
archive_reason: "Move baseline completed source to stable typed target docs/98.archive/changes/chg-0095-document-contract-canonicalization/plan.md; migrate 4 resolved inbound link(s) with it."
archive_disposition: evidence-preserve
archived_commit: 232effd9a5e00907bdbe30efc6665023fb2d07f4
archived_blob: bd394d0a58bfd26faf278ac8d5d772020676bf7a
...
- **Task Evidence**:
  [Document contract canonicalization task](task.md)
- **Parent Program**:
