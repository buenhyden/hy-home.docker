...
parent_ids: []
archived_from: docs/04.execution/tasks/2026-06-05-language-policy-task-normalization-batch-4.md
archived_at: 2026-08-11
archive_reason: "Move baseline completed source to stable typed target docs/98.archive/changes/chg-0135-language-policy-task-normalization-batch-4/task.md; migrate 5 resolved inbound link(s) with it."
archive_disposition: evidence-preserve
archived_commit: 232effd9a5e00907bdbe30efc6665023fb2d07f4
archived_blob: b870440531a942358707119cdc5ca3215725ac6a
preservation_class: git-history
---
<!-- Target: docs/04.execution/tasks/2026-06-05-language-policy-task-normalization-batch-4.md -->

# Task: Language Policy Task Normalization Batch 4

## Overview

This task records the fourth bounded `docs/04.execution/tasks` normalization
pass for the repository language policy goal. It normalizes 7 additional
optimization and hardening task leaf documents to English-only content while
preserving historical execution meaning, commands, path evidence, checklist
state, deferred runtime boundaries, and verification boundaries.
...
- **Previous Evidence**: [Language Policy Task Normalization Batch 3](../chg-0134-language-policy-task-normalization-batch-3/task.md)
...
- Preserve commands, paths, service names, agent names, evidence IDs, Docker
  ...
  no-touch boundaries, checklist state, deferred runtime status, and historical
...
| --- | --- | --- | --- | --- | --- | --- |
| `docs/04.execution/tasks` bounded leaf batch | User-provided language policy objective and continuation request | 7 task files | `docs/04.execution/tasks` leaf backlog was 20 files after task batch 3 | 7 additional task files have no Korean text; task backlog is 13 files | `git revert` or equivalent patch | No secret values, tokens, private keys, certificate contents, raw logs, shell history, or `.env` values |

## Task Table

| Task ID | Description | Type | Parent Spec / Section | Parent Plan / Phase | Validation / Evidence | Owner | Status |
| --- | --- | --- | --- | --- | --- | --- | --- |
| T-001 | Normalize the fourth bounded `docs/04.execution/tasks` leaf batch to English. | doc | User constraint / tasks English-only | Task normalization batch 4 | Korean-character scan against 7 target files | Codex | Done |
...
- [Gateway Optimization Hardening Task](../chg-0015-01-gateway-optimization-hardening/task.md)
- [Auth Optimization Hardening Task](../chg-0016-02-auth-optimization-hardening/task.md)
- [Security Optimization Hardening Task](../chg-0017-03-security-optimization-hardening/task.md)
- [Data Optimization Hardening Task](../chg-0018-04-data-optimization-hardening/task.md)
- [Messaging Optimization Hardening Task](../chg-0019-05-messaging-optimization-hardening/task.md)
- [Observability Optimization Hardening Task](../chg-0020-06-observability-optimization-hardening/task.md)
- [Workflow Optimization Hardening Task](../chg-0021-07-workflow-optimization-hardening/task.md)
...
| Korean-character file count under `docs/04.execution/tasks` excluding `README.md` | 13 leaf files remain after this batch. |
...
- Full English-only normalization remains incomplete for execution evidence:
  13 task leaf files still contain Korean text.
...
- **Task Batch 2 Evidence**: [2026-06-05-language-policy-task-normalization-batch-2.md](../chg-0133-language-policy-task-normalization-batch-2/task.md)
- **Task Batch 3 Evidence**: [2026-06-05-language-policy-task-normalization-batch-3.md](../chg-0134-language-policy-task-normalization-batch-3/task.md)
