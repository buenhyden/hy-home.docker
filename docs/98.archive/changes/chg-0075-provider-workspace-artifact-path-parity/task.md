...
parent_ids: []
archived_from: docs/04.execution/tasks/2026-07-05-provider-workspace-artifact-path-parity.md
archived_at: 2026-08-11
archive_reason: "Move baseline completed source to stable typed target docs/98.archive/changes/chg-0075-provider-workspace-artifact-path-parity/task.md; migrate 3 resolved inbound link(s) with it."
archive_disposition: evidence-preserve
archived_commit: 232effd9a5e00907bdbe30efc6665023fb2d07f4
archived_blob: c501dc66d084ee8da672d09aae11a51077b6e8f9
...
- **Parent Plan**: [Provider Workspace Artifact Path Parity Plan](plan.md)
- **Workspace Support Surface Spec**: [Workspace support surface contract](../../tombstones/03.specs/spec-0106-workspace-support-surface-contract.md)
...
| Workspace support surface | [Workspace support surface contract](../../tombstones/03.specs/spec-0106-workspace-support-surface-contract.md) | Defines `_workspace/repo-support/` as approved staging path. |
...
- **Parent Plan**: [Provider Workspace Artifact Path Parity Plan](plan.md)
- **Workspace Support Surface Spec**: [Workspace support surface contract](../../tombstones/03.specs/spec-0106-workspace-support-surface-contract.md)
- **Workflow Agent Design**: [Workflow agent design](../../../03.specs/spec-0008-workflow/spec.md)
