...
parent_ids: []
archived_from: docs/04.execution/tasks/2026-06-05-language-policy-task-normalization-batch-5.md
archived_at: 2026-08-11
archive_reason: "Move baseline completed source to stable typed target docs/98.archive/changes/chg-0136-language-policy-task-normalization-batch-5/task.md; migrate 5 resolved inbound link(s) with it."
archive_disposition: evidence-preserve
archived_commit: 232effd9a5e00907bdbe30efc6665023fb2d07f4
archived_blob: cfa0f606f242a5ca578ba62d96ffe97336a83180
preservation_class: git-history
---
<!-- Target: docs/04.execution/tasks/2026-06-05-language-policy-task-normalization-batch-5.md -->

# Task: Language Policy Task Normalization Batch 5

## Overview

This task records the fifth bounded `docs/04.execution/tasks` normalization pass
for the repository language policy goal. It normalizes 6 additional workflow,
AI, tooling, laboratory, and governance task leaf documents to English-only
content while preserving historical execution meaning, commands, path evidence,
checklist state, deferred runtime boundaries, and verification boundaries.
...
- **Previous Evidence**: [Language Policy Task Normalization Batch 4](../chg-0135-language-policy-task-normalization-batch-4/task.md)
...
| --- | --- | --- | --- | --- | --- | --- |
| `docs/04.execution/tasks` bounded leaf batch | User-provided language policy objective and continuation request | 6 task files | `docs/04.execution/tasks` leaf backlog was 13 files after task batch 4 | 6 additional task files have no Korean text; task backlog is 7 files | `git revert` or equivalent patch | No secret values, tokens, private keys, certificate contents, raw logs, shell history, or `.env` values |

## Task Table

| Task ID | Description | Type | Parent Spec / Section | Parent Plan / Phase | Validation / Evidence | Owner | Status |
| --- | --- | --- | --- | --- | --- | --- | --- |
| T-001 | Normalize the fifth bounded `docs/04.execution/tasks` leaf batch to English. | doc | User constraint / tasks English-only | Task normalization batch 5 | Korean-character scan against 6 target files | Codex | Done |
...
- [Workflow Standardization Task](../chg-0110-07-workflow/task.md)
- [AI Standardization Task](../chg-0111-08-ai/task.md)
- [AI Optimization Hardening Task](../chg-0022-08-ai-optimization-hardening/task.md)
- [Tooling Optimization Hardening Task](../chg-0023-09-tooling-optimization-hardening/task.md)
- [Laboratory Optimization Hardening Task](../chg-0024-11-laboratory-optimization-hardening/task.md)
- [Governance Optimization Task](../chg-0061-governance-optimization/task.md)
...
| Korean-character file count under `docs/04.execution/tasks` excluding `README.md` | 7 leaf files remain after this batch. |
...
- Full English-only normalization remains incomplete for execution evidence:
  7 task leaf files still contain Korean text.
