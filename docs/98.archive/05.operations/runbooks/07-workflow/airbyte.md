...
archive_reason: Airbyte has no tracked infra implementation under infra/07-workflow/airbyte and must not remain an active runbook.
current_replacement: docs/03.specs/07-workflow/spec.md
---
<!-- Target: docs/98.archive/05.operations/runbooks/07-workflow/airbyte.md -->
