---
title: 0015-security Optimization Hardening Requirements Tombstone
version: 1.0.0
type: archive/tombstone
layer: archive
status: completed
owner: "@buenhyden"
artifact_id: tomb-REQ-0015
...
`docs/01.requirements/0015-security-optimization-hardening.md`

## Replacement

`docs/05.operations/catalog/03-security/`
...
for every stage. The domain's solution-independent requirement is REQ-0003.
