---
title: 0022-laboratory Optimization Hardening Requirements Tombstone
version: 1.0.0
type: archive/tombstone
layer: archive
status: completed
owner: "@buenhyden"
artifact_id: tomb-REQ-0022
...
`docs/01.requirements/0022-laboratory-optimization-hardening.md`

## Replacement

`docs/05.operations/catalog/11-laboratory/0074-optimization-hardening/policy.md`
...
for every stage. The domain's solution-independent requirement is REQ-0012.
