...
parent_ids: []
archived_from: docs/05.operations/guides/05-messaging/ksql-streaming.md
archived_at: '2026-06-04'
archive_reason: ksqlDB는 현재 `05-messaging` 구현이 아니라 `infra/04-data/analytics/ksql` 및
  `04-data/analytics` operations 문서가 소유한다.
archive_disposition: duplicate
archived_commit: b9a96ac0995fd665f6b121d69483a5c83300823e
archived_blob: 6b1d810ce3007750b44b5f145b145cbe724a8e07
preservation_class: git-history
current_replacement: docs/05.operations/04-data/ops-0018-analytics-ksqldb/guide.md
---
...
- [Current ksqlDB guide](../../../05.operations/04-data/ops-0018-analytics-ksqldb/guide.md)
