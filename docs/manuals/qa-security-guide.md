...
| **Style Guide**            | Are code style conventions (naming, folder structure, module splitting) documented?  | _Optional_    |                    |
| **Code Complexity**        | Is there an agreed-upon limit for cyclomatic complexity or file size?                | _Optional_    |                    |
