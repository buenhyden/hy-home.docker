...
- **Test Commands**:
  ...
  - `bash scripts/knowledge/generate-llm-wiki-index.sh` — regenerated `docs/90.references/llm-wiki/index.md` with 1030 paths after staging the new Phase 4 Stage 04 artifacts.
