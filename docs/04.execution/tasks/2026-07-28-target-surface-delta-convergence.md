...
| T-TSDC-004R-2 design reset | Finalize descriptor capability and runner-owned invocation lifecycle | `docs(plan): harden typed gate runner redesign` | pending | `5f5c746e` reviews returned Spec C0/I3/M0 and Quality/Security C0/I5/M1, so its design is superseded. The corrected design fixes adopted FD M lifetime, runner PGID finalization, pidfd-only identity evidence, exact HOME retry, five-path implementation allowlist, and 17bb5cdd contract/workflow/manifest freezes; one implementation attempt remains. |
...
| T-TSDC-004R-2 typed gate runner | corrected design pending implementation | Initial `5819c8ab` reviews were Spec C0/I2/M0 and Quality/Security C0/I5/M1; first remediation reviews were Spec C0/I2/M0 and Quality/Security C0/I2/M1. The `5f5c746e` design reset then received Spec C0/I3/M0 and Quality/Security C0/I5/M1. No review authorizes Wave B; manifest verdicts remain pending. | commit the corrected docs-only design, execute one five-path bounded implementation attempt, obtain a new independent C0/I0 pair, then commit controller review evidence before Wave B |
