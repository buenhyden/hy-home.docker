...
| T-AGCC-003 | `/root/task3_shared_memory` | `/root/task3_spec_review` | not_assigned | `cc7f515a..6a1a9fe3` | review_pending | specification C0/I0/M1 APPROVED; sole missing-commit Minor corrected with `6a1a9fe3`; quality/security review pending |
