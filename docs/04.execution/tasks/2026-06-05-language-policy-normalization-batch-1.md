...
| `docs/90.references/docker/README.md` | Docker image/version interpretation and registry context | Korean prose with image/tag, Compose path, JSON key, and command terms preserved |
| `docs/90.references/glossary/README.md` | Stable vocabulary and stage-boundary terms | Korean definitions with canonical stage and technical terms preserved |
| `docs/90.references/hads/README.md` | HADS profile and validator-backed AI-readable boundary | English allowed for HADS/profile/validator terms; Korean explanatory notes allowed |
| `docs/90.references/kubernetes/README.md` | Kubernetes and k3s/k3d migration reference context | Korean prose with Kubernetes/k3s/k3d resource terms preserved |
