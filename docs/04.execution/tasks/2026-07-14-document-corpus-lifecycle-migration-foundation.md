...
| T-DCLM-002 | Lifecycle companion, Git provenance, deterministic data | Review remediation complete — focused and compatibility gates PASS; fresh independent re-reviews pending |
