...
| T-DCLM-002 | Lifecycle companion, Git provenance, deterministic data | Release-gate remediation implemented — distinct source/canonical merge identities and descriptor-held atomic output sinks are covered across all five writers and three checkers; focused, full, compatibility, live, generated, and repository gates PASS; fresh independent re-reviews pending |
