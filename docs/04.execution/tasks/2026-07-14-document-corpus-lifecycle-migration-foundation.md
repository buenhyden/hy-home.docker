...
| T-DCLM-002 | Lifecycle companion, Git provenance, deterministic data | Final-review remediation implemented — safety, archive, partition, focused, compatibility, and repository gates PASS; fresh independent re-reviews pending |
