...
- **Previous Evidence**: [Language Policy Plan Normalization Batch 2](./2026-06-05-language-policy-plan-normalization-batch-2.md)
...
- [Security Tier Documentation Standardization Implementation Plan](../plans/2026-03-26-03-security-standardization.md)
- [Observability Standardization Plan](../plans/2026-03-26-06-observability-standardization.md)
- [Docs Taxonomy and AI Agent-first Contract Migration Plan](../plans/2026-05-10-docs-taxonomy-agent-first-migration.md)
- [Targeted Documentation Precision Remediation Plan](../plans/2026-05-18-targeted-docs-precision-remediation.md)
- [Lifecycle README Debt Closure Plan](../plans/2026-05-22-lifecycle-readme-debt-closure.md)
- [Workspace Docs and Agent Governance Remediation Plan](../plans/2026-05-22-workspace-docs-agent-governance-remediation.md)
- [Workspace Governance Bounded Re-audit Implementation Plan](../plans/2026-05-22-workspace-governance-bounded-reaudit.md)
