...
| Task 4 | Author instructions, models, catalogs, and memory | Assigned requirement and claim rows plus leaf gates | Implementation, validation, and implementer review complete; independent reviews `Not Run` |
...
| Task 4 | Pending commit identity; `docs(research): analyze agents models instructions and memory` | Five agent/model/catalog/memory leaves and execution evidence | Metadata/scope/source/lifecycle/diff PASS; repository contract retains only separate Memory predecessor | Implementer PASS C0/I0; independent specification and quality `Not Run` |
...
- Claim-level decomposition for later authoring units, remaining external-source
  retrieval, old-path scanning, generated refresh, Task 4 independent reviews, and
