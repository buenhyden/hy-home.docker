...
| T-TSC-004 | Deprecated runtime and duplicate disposition | manifest_promotion_ready |
...
| T-TSC-004 | Runtime RED: seven methods with 39 expected subcase failures. Native-replacement RED: two methods with nine expected old-signature errors; contract wording RED: one method with six expected assertions. Quality I-01 RED: one method with ten expected subcase failures. Exact-row evidence RED: 1/1 failed on preserve/current truth. | Exact promotion focus 2/2, target 18/18, and lifecycle 117/117 GREEN. Direct manifest/static validation zero findings; metadata 3/0/0/0, traceability 46/0, canonical manifest/summary, diff hygiene, and empty index pass. | manifest_promotion_ready |
