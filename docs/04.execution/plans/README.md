...
├── 2026-07-03-document-contract-remediation-batches.md # Active document contract remediation batch plan
...
├── 2026-07-04-document-restructure-audit-contract-archive.md # Active second-wave document restructure plan
└── README.md                               # This file
```
