...
├── 2026-08-08-agentic-research-pack-rebuild.md # Active source-backed agentic research pack rebuild plan
...
├── 2026-07-11-security-supply-chain-remediation.md # Completed local supply-chain plan
├── 2026-07-11-deployment-release-engineering-remediation.md # Completed local promotion and rollback plan
...
- **Agentic Engineering Research Pack Rebuild Plan (active)**: [2026-08-08-agentic-research-pack-rebuild.md](./2026-08-08-agentic-research-pack-rebuild.md)
...
- **Security Supply-Chain Remediation Plan (completed local contract)**: [Plan](./2026-07-11-security-supply-chain-remediation.md); [domain Task evidence owner](../tasks/2026-07-19-security-supply-chain-remediation.md)
- **Deployment and Release Engineering Remediation Plan (completed local contract)**: [Plan](./2026-07-11-deployment-release-engineering-remediation.md); [domain Task evidence owner](../tasks/2026-07-19-deployment-release-engineering-remediation.md)
