...
├── 2026-07-19-operational-readiness-closure-program.md # Active prospective orchestration for Specs 124-127
├── 2026-07-11-compose-runtime-readiness-remediation.md # Active prospective local Compose readiness plan
├── 2026-07-11-infrastructure-operations-readiness-remediation.md # Active prospective synthetic PostgreSQL recovery plan
├── 2026-07-11-security-supply-chain-remediation.md # Active prospective local supply-chain plan
├── 2026-07-11-deployment-release-engineering-remediation.md # Active prospective local promotion and rollback plan
...
- **Operational Readiness Closure Program Plan (active prospective contract)**: [Plan](./2026-07-19-operational-readiness-closure-program.md); [Program Task evidence owner](../tasks/2026-07-19-operational-readiness-closure-program.md)
- **Compose Runtime Readiness Remediation Plan (active prospective contract)**: [Plan](./2026-07-11-compose-runtime-readiness-remediation.md); [domain Task evidence owner](../tasks/2026-07-19-compose-runtime-readiness-remediation.md)
- **Infrastructure Operations Readiness Remediation Plan (active prospective contract)**: [Plan](./2026-07-11-infrastructure-operations-readiness-remediation.md); [domain Task evidence owner](../tasks/2026-07-19-infrastructure-operations-readiness-remediation.md)
- **Security Supply-Chain Remediation Plan (active prospective contract)**: [Plan](./2026-07-11-security-supply-chain-remediation.md); [domain Task evidence owner](../tasks/2026-07-19-security-supply-chain-remediation.md)
- **Deployment and Release Engineering Remediation Plan (active prospective contract)**: [Plan](./2026-07-11-deployment-release-engineering-remediation.md); [domain Task evidence owner](../tasks/2026-07-19-deployment-release-engineering-remediation.md)
