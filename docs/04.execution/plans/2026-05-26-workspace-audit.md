...
| PLN-003 | Env 키 비교 보고서 생성                 | `docs/05.operations/guides/env-key-comparison.md`                                                                             | Low  | secret 값 미포함, 키 이름만                      |
| PLN-004 | Secrets 키 비교 보고서 생성             | `docs/05.operations/guides/sensitive-env-vars-comparison.md`                                                                  | Low  | secret 값 미포함, ID/경로만                      |
