...
> 기준 문서: `docs/05.operations/policies/infra-service-optimization-catalog.md`
...
- 기준 문서: [infra-service-optimization-catalog.md](../../05.operations/policies/infra-service-optimization-catalog.md)
- 기준 데이터(39개 서비스 스냅샷):
  - `healthcheck` 미구성: 6
  - `restart` 미구성: 21
