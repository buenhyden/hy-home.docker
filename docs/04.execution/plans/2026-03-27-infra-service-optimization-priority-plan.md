...
| PLN-QW-004 | 리소스 최소 상한(`cpus`, `memory`) 정책 초안 확정 | `docs/05.operations/policies/12-infra-service-optimization-catalog.md`, `docs/04.execution/tasks/*` | REQ-OPS-CAP-004 | 티어별 최소 상한 정책 문서화 완료 |
