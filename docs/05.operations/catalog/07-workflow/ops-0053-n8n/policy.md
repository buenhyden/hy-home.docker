...
updated: 2026-08-11
---
<!-- Target: docs/05.operations/catalog/07-workflow/ops-0053-n8n/policy.md -->
...
- 정책 예외는 사용자 승인과 관련 plan/task evidence가 있을 때만 허용한다. 긴급 장애 복구 절차는 [n8n recovery runbook](runbook.md)을 따른다.
