...
updated: 2026-08-11
---
<!-- Target: docs/05.operations/catalog/08-ai/ops-0059-rag-workflow/guide.md -->
...
반복 실행 절차, 장애 대응, rollback 또는 escalation 기준은 [Open WebUI recovery runbook](../ops-0057-open-webui/runbook.md)을 따른다.

## Related Documents

- [Operations index](../../../README.md)
- [Open WebUI usage guide](../ops-0057-open-webui/guide.md)
- [Open WebUI operations policy](../ops-0057-open-webui/policy.md)
- [Open WebUI recovery runbook](../ops-0057-open-webui/runbook.md)
