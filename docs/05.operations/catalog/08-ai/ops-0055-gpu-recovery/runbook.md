...
updated: 2026-08-11
---
<!-- Target: docs/05.operations/catalog/08-ai/ops-0055-gpu-recovery/runbook.md -->
...
2. If a recent model change triggered VRAM exhaustion, unload or remove the model according to [Ollama runbook](../ops-0056-ollama/runbook.md).
...
- [Ollama usage guide](../ops-0056-ollama/guide.md)
- [Ollama operations policy](../ops-0056-ollama/policy.md)
- [Ollama runbook](../ops-0056-ollama/runbook.md)
