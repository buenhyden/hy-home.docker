...
2. If a recent model change triggered VRAM exhaustion, unload or remove the model according to [Ollama runbook](../0056-ollama/runbook.md).
...
- [Ollama operations policy](../0056-ollama/policy.md)
- [Ollama runbook](../0056-ollama/runbook.md)
