...
updated: 2026-08-11
---
<!-- Target: docs/05.operations/catalog/09-tooling/ops-0067-syncthing/guide.md -->
...
3. If persistent, refer to the [Procedure](runbook.md) for database reset procedures.
