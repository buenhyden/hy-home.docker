...
updated: 2026-08-11
---
<!-- Target: docs/05.operations/catalog/09-tooling/ops-0064-performance-testing/guide.md -->
...
1. 테스트 목적에 맞는 leaf를 선택한다.
   - 분산 worker가 필요하면 [Locust guide](../ops-0062-locust/guide.md)를 사용한다.
   - `k6` leaf의 현재 wrapper 계약을 확인하려면 [k6 guide](../ops-0061-k6/guide.md)를 사용한다.
