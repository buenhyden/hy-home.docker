...
1. 테스트 목적에 맞는 leaf를 선택한다.
   - 분산 worker가 필요하면 [Locust guide](../0062-locust/guide.md)를 사용한다.
   - `k6` leaf의 현재 wrapper 계약을 확인하려면 [k6 guide](../0061-k6/guide.md)를 사용한다.
...
- Declared parent: [Performance Testing Operations Policy](policy.md) (`POL-0064`)
...
- Subject peers: [Policy](policy.md) (`POL-0064`), [Runbook](runbook.md) (`RUN-0064`)
