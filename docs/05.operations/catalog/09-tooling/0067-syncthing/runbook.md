...
status: active
owner: "@buenhyden"
artifact_id: RUN-0067
parent_ids: []
created: 2026-05-17
updated: 2026-08-11
---
<!-- Target: docs/05.operations/catalog/09-tooling/0067-syncthing/runbook.md -->
...
이 런북은 `docs/05.operations/catalog/09-tooling/0067-syncthing/runbook.md` 주제의 실행 절차를 정의한다. 기존 절차를 유지하면서 검증, evidence, rollback 기준을 명확히 한다.
