...
- Runtime이 실행 중이면 `docker logs --tail=100 dashboard`
...
- Declared parent: [Laboratory Dashboard Operations Policy](policy.md) (`POL-0071`)
...
- Subject peers: [Policy](policy.md) (`POL-0071`), [Runbook](runbook.md) (`RUN-0071`)
