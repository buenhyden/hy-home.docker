...
<!-- Target: docs/05.operations/catalog/00-workspace/ops-0008-new-service-onboarding/guide.md -->
...
(`docs/99.templates/templates/spec-contracts/service.template.md`)을 사용해, 보안 하드닝·이미지 핀·
...
5. 런타임 계약을 `docs/99.templates/templates/spec-contracts/service.template.md`를 복사해 해당 feature의 `docs/03.specs/` 스펙 디렉터리 아래 `service.md`로 문서화한다.
...
[recovery runbook](../ops-0009-release-management/runbook.md)을 따른다.

## Related Documents

- [Operations index](../../../README.md)
- [Service scaffold template](../../../../99.templates/templates/spec-contracts/service.template.md)
