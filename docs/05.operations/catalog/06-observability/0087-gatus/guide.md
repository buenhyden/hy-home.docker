...
image and configuration, then use the [runbook](runbook.md) after runtime
...
approval before replacement. The central [backup policy](../../04-data/0021-backup-and-restore/policy.md) owns shared retention and custody controls.
...
Use the [Gatus Runbook](runbook.md) for approval-gated diagnosis, restart and recovery.
