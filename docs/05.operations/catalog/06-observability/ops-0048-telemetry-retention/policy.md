...
- Pyroscope no-fixed-retention boundary:
  `rg -n 'fixed retention period is not declared|고정 7일 retention 설정이 없다' infra/06-observability/pyroscope/README.md docs/05.operations/catalog/06-observability/ops-0047-pyroscope/guide.md`
