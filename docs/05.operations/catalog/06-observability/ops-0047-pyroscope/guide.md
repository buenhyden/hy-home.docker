...
updated: 2026-08-11
---
<!-- Target: docs/05.operations/catalog/06-observability/ops-0047-pyroscope/guide.md -->
...
- [Grafana Alloy](../ops-0040-alloy/guide.md)에 `pyroscope.write "local_pyroscope"` endpoint `http://pyroscope:4040`이 있어야 한다.
- [Grafana](../ops-0041-grafana/guide.md)에 Pyroscope datasource URL `http://pyroscope:4040`이 provisioning되어 있어야 한다.
