...
updated: 2026-08-11
---
<!-- Target: docs/05.operations/09-tooling/ops-0065-registry/runbook.md -->

# Docker Registry Runbook

## Overview

이 런북은 `docs/05.operations/09-tooling/ops-0065-registry/runbook.md` 주제의 실행 절차를 정의한다. 기존 절차를 유지하면서 검증, evidence, rollback 기준을 명확히 한다.
