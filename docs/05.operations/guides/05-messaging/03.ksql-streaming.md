...
status: migrated
---
<!-- Target: docs/05.operations/05-messaging/03.ksql-streaming.md -->

# 03.Ksql Streaming Operations

> Migrated from `docs/05.operations/05-messaging/03.ksql-streaming.md` during the 2026-05-10 operations taxonomy consolidation.
...
- [Primary Specification](../../../03.specs/05-messaging/spec.md)
- [Kafka Usage](./kafka.md)
- [Recovery Procedure](./README.md)
