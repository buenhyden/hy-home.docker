...
- **Procedure**: `[../../05.operations/05-messaging/kafka.md]`
- **Usage**: `[../../05.operations/05-messaging/kafka.md]`
...
> Migrated from `docs/05.operations/05-messaging/kafka.md` during the 2026-05-10 operations taxonomy consolidation.
...
- [Kafka Operation Policy](./kafka.md)
- **Operation**: `[../../05.operations/05-messaging/kafka.md]`
- **Procedure**: `[../../05.operations/05-messaging/kafka.md]`
...
- **Incident examples**: `[../../05.operations/incidents/2026/2026-03-26-kafka-quorum-loss.md]` (예시)
- **Postmortem examples**: `[../../05.operations/incidents/2026/2026-03-26-kafka-balancing-failure-postmortem.md]` (예시)
