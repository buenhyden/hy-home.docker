...
3. guide leaf 문서는 `docs/99.templates/templates/operations/guide.template.md`의 `## Usage` profile을 하나의 primary wrapper로 사용하고, `### Usage Type` 같은 profile heading을 중복 작성하지 않습니다.
