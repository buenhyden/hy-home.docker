...
- [Optimization Hardening Operations Policy](../../policies/09-tooling/optimization-hardening.md)
...
- [Tooling Plan](../../../04.execution/plans/2026-03-28-09-tooling-optimization-hardening-plan.md)
- [Tooling Tasks](../../../04.execution/tasks/2026-03-28-09-tooling-optimization-hardening-tasks.md)
- [Optimization Catalog](../../policies/12-infra-service-optimization-catalog.md)
...
> Migrated from `docs/05.operations/09-tooling/README.md` during the 2026-05-10 operations taxonomy consolidation.
...
이 디렉터리는 Tooling 계층(terraform, terrakube, registry, sonarqube, k6, locust, syncthing)의 사용 방법과 하드닝 적용 절차를 제공한다. 운영 정책은 `05.operations`, 장애 대응은 `05.operations`에서 관리한다.
...
- [10. Optimization Hardening Usage](../../policies/09-tooling/optimization-hardening.md)
...
- [Tooling PRD](../../../01.requirements/2026-03-28-09-tooling-optimization-hardening.md)
- [Tooling Spec](../../../03.specs/09-tooling/spec.md)
- [Tooling Plan](../../../04.execution/plans/2026-03-28-09-tooling-optimization-hardening-plan.md)
- [Tooling Tasks](../../../04.execution/tasks/2026-03-28-09-tooling-optimization-hardening-tasks.md)
- [Tooling Operations](./README.md)
- [Tooling Procedures](./README.md)
...
- [Optimization Hardening Procedure](../../policies/09-tooling/optimization-hardening.md)
