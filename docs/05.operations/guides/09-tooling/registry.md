<!-- Target: docs/05.operations/09-tooling/registry.md -->
...
- **Procedure**: [../05.operations/09-tooling/registry.md](./registry.md)

## Usage

> Migrated from `docs/05.operations/09-tooling/registry.md` during the 2026-05-10 operations taxonomy consolidation.
...
- **Operation**: [../05.operations/09-tooling/registry.md](./registry.md)
- **Procedure**: [../05.operations/09-tooling/registry.md](./registry.md)
...
- [Operations](./registry.md)

---

#### Overview (KR)

이 런북은 `docs/05.operations/09-tooling/registry.md` 주제의 실행 절차를 정의한다. 기존 절차를 유지하면서 검증, evidence, rollback 기준을 명확히 한다.
