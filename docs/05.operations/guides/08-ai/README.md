...
- 단계별 복구 커맨드 (05.operations)
- 사용/학습 가이드 (05.operations)
...
- [08-AI Optimization Hardening Operations Policy](../../policies/08-ai/optimization-hardening.md)
...
- [AI Spec (공통)](../../../03.specs/08-ai/spec.md)
- [Open WebUI Spec](../../../03.specs/08-ai/open-webui.md)
- [AI Optimization PRD](../../../01.requirements/2026-03-28-08-ai-optimization-hardening.md)
- [AI Optimization Plan](../../../04.execution/plans/2026-03-28-08-ai-optimization-hardening-plan.md)
- [AI Optimization Tasks](../../../04.execution/tasks/2026-03-28-08-ai-optimization-hardening-tasks.md)

## Usage

> Migrated from `docs/05.operations/08-ai/README.md` during the 2026-05-10 operations taxonomy consolidation.
...
- 정책/통제 기준 정의 (05.operations)
- 장애 대응/복구 절차 (05.operations)
- 사고 기록/회고 문서
...
- [08-AI Optimization Hardening Usage](../../policies/08-ai/optimization-hardening.md)
...
- [AI ARD (공통)](../../../02.architecture/requirements/0008-ai-architecture.md)
- [Open WebUI ARD](../../../02.architecture/requirements/0013-open-webui-architecture.md)
- [AI Optimization PRD](../../../01.requirements/2026-03-28-08-ai-optimization-hardening.md)
- [AI Optimization Plan](../../../04.execution/plans/2026-03-28-08-ai-optimization-hardening-plan.md)
- [AI Optimization Tasks](../../../04.execution/tasks/2026-03-28-08-ai-optimization-hardening-tasks.md)
...
- 정책 기준 정의 (05.operations)
- 기능 사용 가이드 (05.operations)
- 사고 분석/회고 (10/11)
...
- [GPU Recovery Procedure](../../runbooks/08-ai/gpu-recovery.md)
- [08-AI Optimization Hardening Procedure](../../policies/08-ai/optimization-hardening.md)
...
- [Postmortems](../../incidents/README.md)
- [AI Optimization Plan](../../../04.execution/plans/2026-03-28-08-ai-optimization-hardening-plan.md)
- [AI Optimization Tasks](../../../04.execution/tasks/2026-03-28-08-ai-optimization-hardening-tasks.md)
