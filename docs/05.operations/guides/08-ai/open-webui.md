<!-- Target: docs/05.operations/guides/08-ai/open-webui.md -->
...
- **Usage**: `[../../05.operations/08-ai/open-webui.md]`
- **Procedure**: `[../../05.operations/08-ai/open-webui.md]`
- **Postmortem**: `[../../05.operations/incidents/README.md]`

## Usage

> Migrated from `docs/05.operations/08-ai/open-webui.md` during the 2026-05-10 operations taxonomy consolidation.
...
- **PRD (Open WebUI)**: `[../../01.requirements/2026-03-27-08-ai-open-webui.md]`
- **ARD (Open WebUI)**: `[../../02.architecture/requirements/0013-open-webui-architecture.md]`
- **ADR (Open WebUI)**: `[../../02.architecture/decisions/0016-open-webui-implementation.md]`
- **Spec (Open WebUI)**: `[../../03.specs/08-ai/open-webui.md]`
- **Plan (Open WebUI)**: `[../../04.execution/plans/2026-03-27-08-ai-open-webui-plan.md]`
- **Task (Open WebUI)**: `[../../04.execution/tasks/2026-03-27-08-ai-open-webui-tasks.md]`
- **Operation**: `[../../05.operations/08-ai/open-webui.md]`
- **Procedure**: `[../../05.operations/08-ai/open-webui.md]`
...
- **Operations Policy**: `[../../05.operations/08-ai/open-webui.md]`
- **Usage**: `[../../05.operations/08-ai/open-webui.md]`
