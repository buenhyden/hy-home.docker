...
status: active
---
<!-- Target: docs/05.operations/guides/11-laboratory/dozzle.md -->
...
반복 실행 절차, 장애 대응, rollback 또는 escalation 기준은 [recovery runbook](../../runbooks/11-laboratory/dozzle.md)을 따른다.
