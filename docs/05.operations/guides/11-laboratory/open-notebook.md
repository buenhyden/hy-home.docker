...
- **Usage**: [../../05.operations/11-laboratory/open-notebook.md](./open-notebook.md)
- **Procedure**: [../../05.operations/11-laboratory/open-notebook.md](./open-notebook.md)
...
> Migrated from `docs/05.operations/11-laboratory/open-notebook.md` during the 2026-05-10 operations taxonomy consolidation.
...
- **Infra Source**: [../../../infra/11-laboratory/open-notebook/docker-compose.yml](../../../../infra/11-laboratory/open-notebook/docker-compose.yml)
- **Spec**: [../../03.specs/11-laboratory/spec.md](../../../03.specs/11-laboratory/spec.md)
- **Operation**: [../../05.operations/11-laboratory/open-notebook.md](./open-notebook.md)
- **Procedure**: [../../05.operations/11-laboratory/open-notebook.md](./open-notebook.md)
...
- [../../05.operations/11-laboratory/open-notebook.md](./open-notebook.md)
- [../../05.operations/11-laboratory/open-notebook.md](./open-notebook.md)
...
- [ ] 새 노트북 생성/저장이 성공한다.
- [ ] `bash scripts/hardening/check-laboratory-hardening.sh`가 통과한다.
...
- **Operation**: [../../05.operations/11-laboratory/open-notebook.md](./open-notebook.md)
- **Usage**: [../../05.operations/11-laboratory/open-notebook.md](./open-notebook.md)
- **Incident examples**: [../../05.operations/incidents/README.md](../../incidents/README.md)
- **Postmortem examples**: [../../05.operations/incidents/README.md](../../incidents/README.md)
