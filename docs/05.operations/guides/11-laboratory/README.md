...
- [Optimization Hardening Policy](../../policies/11-laboratory/optimization-hardening.md): gateway+allowlist+SSO, 최소권한, CI 게이트, 카탈로그 확장 승인 조건
...
- **Usage Index**: [../../05.operations/11-laboratory/README.md](./README.md)
- **Procedure Index**: [../../05.operations/11-laboratory/README.md](./README.md)
- **Template**: [../../99.templates/operation.template.md](../../../99.templates/operation.template.md)

## Usage

> Migrated from `docs/05.operations/11-laboratory/README.md` during the 2026-05-10 operations taxonomy consolidation.
...
이 디렉터리는 `11-laboratory` 계층의 관리 UI와 실험 도구를 안전하게 사용하는 방법을 정리한다. 각 가이드는 사람이 직접 따라 할 수 있는 접근/확인 절차를 제공하며, 운영 정책과 장애 대응 절차는 각각 `docs/05.operations/11-laboratory/`와 `docs/05.operations/11-laboratory/`에서 관리한다.
...
- [Optimization Hardening Usage](../../policies/11-laboratory/optimization-hardening.md): gateway+allowlist+SSO 경계, 최소권한, 정책 게이트 적용 절차
...
1. 새 laboratory 서비스를 추가할 때는 먼저 `infra/11-laboratory/<service>/docker-compose.yml`과 `docs/03.specs/11-laboratory/spec.md`를 확인한다.
...
- **Spec**: [../../03.specs/11-laboratory/spec.md](../../../03.specs/11-laboratory/spec.md)
- **Operations Index**: [../../05.operations/11-laboratory/README.md](./README.md)
- **Procedures Index**: [../../05.operations/11-laboratory/README.md](./README.md)
- **Template**: [../../99.templates/operation.template.md](../../../99.templates/operation.template.md)
...
이 디렉터리는 `11-laboratory` 계층에서 발생하는 접근 경계 회귀, 설정 드리프트, UI 장애, 데이터 의존성 장애를 빠르게 복구하기 위한 절차 문서를 모은다. 정책 판단은 `docs/05.operations/11-laboratory/`를 따르고, 사용자 사용법은 `docs/05.operations/11-laboratory/`를 따른다.
...
- [Optimization Hardening Procedure](../../policies/11-laboratory/optimization-hardening.md): middleware/allowlist/network/socket/direct exposure 회귀 복구
