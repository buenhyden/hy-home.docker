...
Use the [runbook](../runbooks/0090-dbt.md) for provisioning failure, permission errors and
target-schema recovery.

## Traceability

- [Policy](../policies/0090-dbt.md) (`POL-0090`)
- [Runbook](../runbooks/0090-dbt.md) (`RUN-0090`)
