...
---
[System Usage](./loki.md) | [Recovery Procedure](./loki.md)

---

## Overview (KR)

이 문서는 `docs/05.operations/06-observability/loki.md` 주제의 운영 정책을 정의한다. 기존 운영 내용을 유지하면서 적용 범위, 통제, 검증 기준을 명시한다.
...
> Migrated from `docs/05.operations/06-observability/loki.md` during the 2026-05-10 operations taxonomy consolidation.
...
- **Operational Policy**: `[../../05.operations/06-observability/loki.md]`
- **Recovery Procedure**: `[../../05.operations/06-observability/loki.md]`
...
- [Loki System Usage](./loki.md)
 | [Operational Policy](./loki.md)
