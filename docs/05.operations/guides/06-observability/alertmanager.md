...
이 가이드는 Alertmanager Operational Policy (06-observability) Usage Guide의 사용 맥락, 전제 조건, 일반 점검, runbook handoff 기준을 설명한다.
...
- Alertmanager Operational Policy (06-observability) Usage Guide의 운영 사용 맥락을 빠르게 파악한다.
