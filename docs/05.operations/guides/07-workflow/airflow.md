...
- **Procedure**: [Airflow Recovery Procedure](./airflow.md)
...
> Migrated from `docs/05.operations/07-workflow/airflow.md` during the 2026-05-10 operations taxonomy consolidation.
...
- **Spec**: [07-workflow Spec](../../../03.specs/07-workflow/spec.md)
- **Operation**: [Airflow Operations Policy](./airflow.md)
- **Procedure**: [Airflow Recovery Procedure](./airflow.md)
...
- ARD: [07-workflow Architecture](../../../02.architecture/requirements/0007-workflow-architecture.md)
- Usage: [Airflow System Usage](./airflow.md)
- Policy: [Airflow Operations Policy](./airflow.md)
