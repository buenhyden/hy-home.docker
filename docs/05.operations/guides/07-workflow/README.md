...
- 서비스 사용 가이드 (05.operations 담당)
- 장애 조치 절차 (05.operations 담당)
...
- **Usages**: [07-workflow Usages](./README.md)
- **Procedures**: [07-workflow Procedures](./README.md)
- **Optimization PRD**: [2026-03-28-07-workflow-optimization-hardening.md](../../../01.requirements/2026-03-28-07-workflow-optimization-hardening.md)
- **Optimization Tasks**: [2026-03-28-07-workflow-optimization-hardening-tasks.md](../../../04.execution/tasks/2026-03-28-07-workflow-optimization-hardening-tasks.md)

## Usage

> Migrated from `docs/05.operations/07-workflow/README.md` during the 2026-05-10 operations taxonomy consolidation.
...
- 운영 정책/통제 기준 (05.operations 담당)
- 장애 대응/복구 절차 (05.operations 담당)
...
- **Spec**: [07-workflow/spec.md](../../../03.specs/07-workflow/spec.md)
- **Operations**: [07-workflow Operations](./README.md)
- **Procedures**: [07-workflow Procedures](./README.md)
- **Optimization PRD**: [2026-03-28-07-workflow-optimization-hardening.md](../../../01.requirements/2026-03-28-07-workflow-optimization-hardening.md)
- **Optimization Plan**: [2026-03-28-07-workflow-optimization-hardening-plan.md](../../../04.execution/plans/2026-03-28-07-workflow-optimization-hardening-plan.md)
...
- 정책 정의 및 승인 규칙 (05.operations 담당)
- 사용 가이드/온보딩 (05.operations 담당)
...
- **Usages**: [07-workflow Usages](./README.md)
- **Operations**: [07-workflow Operations](./README.md)
- **Incidents**: [Incidents README](../../incidents/README.md)
- **Optimization Plan**: [2026-03-28-07-workflow-optimization-hardening-plan.md](../../../04.execution/plans/2026-03-28-07-workflow-optimization-hardening-plan.md)
- **Optimization Tasks**: [2026-03-28-07-workflow-optimization-hardening-tasks.md](../../../04.execution/tasks/2026-03-28-07-workflow-optimization-hardening-tasks.md)
