...
- **Required**:
  ...
  - 신규 Connector/Sync 정책 변경은 `04.execution/plans`와 `04.execution/tasks` 증적을 남긴다.
- **Allowed**:
...
- **Procedure**: [airbyte.md](./airbyte.md)
- **Postmortem**: [Postmortems README](../../incidents/README.md)

## Usage

> Migrated from `docs/05.operations/07-workflow/airbyte.md` during the 2026-05-10 operations taxonomy consolidation.
...
- **Tasks**: [2026-03-26-07-workflow-tasks.md](../../../04.execution/tasks/2026-03-26-07-workflow-tasks.md)
- **Operation**: [airbyte.md](./airbyte.md)
- **Procedure**: [airbyte.md](./airbyte.md)
...
- **Usage**: [airbyte.md](./airbyte.md)
- **Operation**: [airbyte.md](./airbyte.md)
- **Incident examples**: [Incidents README](../../incidents/README.md)
- **Postmortem examples**: [Postmortems README](../../incidents/README.md)
