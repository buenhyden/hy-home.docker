...
- 긴급 장애 복구 상황에서는 `05.operations/07-workflow/n8n.md`의 절차를 따른다.
...
> Migrated from `docs/05.operations/07-workflow/n8n.md` during the 2026-05-10 operations taxonomy consolidation.
...
- Recovery: [n8n Recovery Procedure](./n8n.md)
...
- ARD: [07-workflow Architecture](../../../02.architecture/requirements/0007-workflow-architecture.md)
- Usage: [n8n System Usage](./n8n.md)
- Policy: [n8n Operations Policy](./n8n.md)
