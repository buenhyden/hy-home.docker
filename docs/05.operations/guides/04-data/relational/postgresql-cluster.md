...
- **Usage**: `docs/05.operations/04-data/relational/postgresql-cluster.md`
- **Procedure**: `docs/05.operations/04-data/relational/postgresql-cluster.md`
- **Infra**: `infra/04-data/relational/postgresql-cluster/README.md`
- **Postmortem**: `docs/05.operations/incidents/`

---

## Overview (KR)

이 문서는 `docs/05.operations/04-data/relational/postgresql-cluster.md` 주제의 운영 정책을 정의한다. 기존 운영 내용을 유지하면서 적용 범위, 통제, 검증 기준을 명시한다.
...
> Migrated from `docs/05.operations/04-data/relational/postgresql-cluster.md` during the 2026-05-10 operations taxonomy consolidation.
...
- **Operation**: `docs/05.operations/04-data/relational/postgresql-cluster.md`
- **Procedure**: `docs/05.operations/04-data/relational/postgresql-cluster.md`
- **Infra**: `infra/04-data/relational/postgresql-cluster/README.md`
...
이 문서는 `docs/05.operations/04-data/relational/postgresql-cluster.md` 주제의 사용 가이드다. 기존 본문을 기준으로 작업자가 필요한 배경, 절차, 주의사항을 빠르게 찾도록 보강한다.
...
- **Incident examples**: `docs/05.operations/incidents/`
- **Postmortem examples**: `docs/05.operations/incidents/`

---

#### Overview (KR)

이 런북은 `docs/05.operations/04-data/relational/postgresql-cluster.md` 주제의 실행 절차를 정의한다. 기존 절차를 유지하면서 검증, evidence, rollback 기준을 명확히 한다.
