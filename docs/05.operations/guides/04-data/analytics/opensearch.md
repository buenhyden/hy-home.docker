...
- **Procedure**: [opensearch.md](./opensearch.md)
...
> Migrated from `docs/05.operations/04-data/analytics/opensearch.md` during the 2026-05-10 operations taxonomy consolidation.
...
- **Operation**: [opensearch.md](./opensearch.md)
- **Procedure**: [opensearch.md](./opensearch.md)
...
- `[../../05.operations/04-data/analytics/opensearch.md]`
- `[../../05.operations/04-data/analytics/opensearch.md]`
...
- **Operations**: [docs/05.operations/04-data/analytics/opensearch.md](./opensearch.md)
