...
- [Auth Plan](../../../04.execution/plans/2026-03-28-02-auth-optimization-hardening-plan.md)
- [Auth Tasks](../../../04.execution/tasks/2026-03-28-02-auth-optimization-hardening-tasks.md)
- [Auth Spec](../../../03.specs/02-auth/spec.md)
- [Auth Procedures](./README.md)
- [Auth Usages](./README.md)
...
`docs/05.operations/02-auth`는 운영 정책, 통제 기준, 검증 방법을 정의하는 operation 위치다. 이 README는 하위 파일을 찾는 진입점이며, 기존 본문과 실제 디렉터리 구조를 함께 기준으로 사용한다.
...
> Migrated from `docs/05.operations/02-auth/README.md` during the 2026-05-10 operations taxonomy consolidation.
...
이 디렉터리는 인증 계층 구성과 운영 변경 방법을 설명한다. 정책은 `05.operations`, 즉시 복구 절차는 `05.operations`를 참조한다.
...
`docs/05.operations/02-auth`는 사용자와 운영자가 재현 가능한 작업 방법을 이해하도록 돕는 guide 위치다. 이 README는 하위 파일을 찾는 진입점이며, 기존 본문과 실제 디렉터리 구조를 함께 기준으로 사용한다.
...
`docs/05.operations/02-auth`는 운영자가 즉시 실행할 수 있는 runbook 위치다. 이 README는 하위 파일을 찾는 진입점이며, 기존 본문과 실제 디렉터리 구조를 함께 기준으로 사용한다.
