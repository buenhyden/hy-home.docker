...
반복 실행 절차, 장애 대응, rollback 또는 escalation 기준은 [recovery runbook](../runbooks/0043-loki.md)을 따른다.

## Traceability

- Declared parent: [Loki Operations Policy](../policies/0043-loki.md) (`POL-0043`)
- Governing authority: [Observability Architecture Description](../../02.architecture/descriptions/0006-observability-architecture.md) (`AD-0006`)
- Subject peers: [Policy](../policies/0043-loki.md) (`POL-0043`), [Runbook](../runbooks/0043-loki.md) (`RUN-0043`)
