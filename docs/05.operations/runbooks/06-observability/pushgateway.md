...
- [ ] Traefik 라우팅 및 SSL 상태 (`https://pushgateway.${DEFAULT_URL}/-/ready`) 또는 내부 service endpoint(`http://pushgateway:9091/-/ready`)
...
- [ ] `curl http://pushgateway:9091/metrics` 명령으로 현재 보관 중인 메트릭 목록 확인.
