...
Use this procedure to run an approved k6 test, or when k6 targets the wrong
endpoint, breaches an agreed limit, fails to export results, or exits
unexpectedly. Commands run from the repository root and name only `k6`.

## Procedure

### Approved Live Run

After the target owner approves the target, traffic ceiling, stop conditions,
and script ([Guide](../guides/0061-k6.md#normal-use)), start only the job and
watch its logs:
...
- Declared parent: [k6 Usage Guide](../guides/0061-k6.md) (`GDE-0061`)
...
- Subject peers: [Guide](../guides/0061-k6.md), [Policy](../policies/0061-k6.md)
