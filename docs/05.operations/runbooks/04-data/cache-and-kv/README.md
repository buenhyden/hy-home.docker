<!-- README Target: docs/05.operations/runbooks/04-data/cache-and-kv/README.md -->

# Operations Runbooks - 04 Data / Cache And Kv

> 복구, 검증, 반복 실행 절차를 명령과 evidence 중심으로 관리한다.

## Overview

`runbooks/04-data/cache-and-kv`는 `docs/05.operations`의 runbook 문서를 관리합니다. 트리거 조건, 순서 있는 절차, evidence, rollback/recovery, escalation을 제공한다. guide, policy, runbook 목적을 섞지 않고 필요한 운영 지식을 빠르게 찾도록 합니다.
...
- [Operations Guides - 04-data / cache-and-kv](../../../guides/04-data/cache-and-kv/README.md)
- [Operations Policies - 04-data / cache-and-kv](../../../policies/04-data/cache-and-kv/README.md)
