...
[hy-home.k8s integration runbook](0096-k8s-integration.md)
...
1. Use the [guide](../guides/0085-openbao.md) to sign in through OIDC, role `home-admin`. Confirm
...
the [hy-home.k8s integration runbook](0096-k8s-integration.md)
