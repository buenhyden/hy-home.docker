<!-- README Target: docs/05.operations/runbooks/01-gateway/README.md -->

# Operations Runbooks - 01 Gateway

> 복구, 검증, 반복 실행 절차를 명령과 evidence 중심으로 관리한다.

## Overview

`runbooks/01-gateway`는 `docs/05.operations`의 runbook 문서를 관리합니다. 트리거 조건, 순서 있는 절차, evidence, rollback/recovery, escalation을 제공한다. guide, policy, runbook 목적을 섞지 않고 필요한 운영 지식을 빠르게 찾도록 합니다.
...
- [Operations Guides - 01-gateway](../../guides/01-gateway/README.md)
