...
This decision refines ADR-0027 for the two-provider target. ADR-0027 remains in
the decision log until the Stage 02 migration records the reciprocal
supersession relationship under the canonical identity contract.
...
- Stage 02 records whether ADR-0029 supersedes ADR-0027 after the canonical
  uppercase identity and reciprocal-link contract is active.
