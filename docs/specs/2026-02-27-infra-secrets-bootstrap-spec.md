...
**Overview (KR):** Docker Secrets 및 mkcert를 이용한 로컬 환경 보안 초기화 스크립트 명세입니다.
layer: infra
...
> **Related ADR**: [../adr/0002-secrets-first-management.md](../adr/2026-02-26-0002-secrets-first-management.md)
