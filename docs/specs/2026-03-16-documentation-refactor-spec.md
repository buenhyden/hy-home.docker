...
> **Scope**: master
> **layer:** specs
> **Related PRD**: `../prd/2026-03-16-documentation-standardization-prd.md`
> **Related Architecture**: `../ard/documentation-system-ard.md`
> **Decision Record**: `../adr/0026-documentation-structure-and-lazy-loading.md`
...
- **Agent Metadata Contract**: All markdown files MUST have YAML frontmatter with `layer: <category>`.
- **Naming Contract**: Plans must use `YYYY-MM-DD-feature.md` format.
- **Lazy Loading Contract**: Rule files in `docs/agentic/rules/` are excluded from the default prompt and only included when a `[LOAD:RULES:<NAME>]` trigger is matched.
