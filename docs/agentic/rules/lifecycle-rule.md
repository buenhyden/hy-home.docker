...
2. **Specify** — If no spec exists, create `docs/specs/<name>.md` from `templates/spec-template.md`.
3. **Plan** — Verify or create `docs/plans/<name>.md` from `templates/plan-template.md`.
