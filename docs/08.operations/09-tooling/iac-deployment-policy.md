...
- [Guide](../../07.guides/09-tooling/01.iac-automation.md)

---

## Overview (KR)

이 문서는 `docs/08.operations/09-tooling/iac-deployment-policy.md` 주제의 운영 정책을 정의한다. 기존 운영 내용을 유지하면서 적용 범위, 통제, 검증 기준을 명시한다.
