...
| --- | --- | --- | --- |
| Tracked Markdown baseline | 930 tracked Markdown files after the three Task 2 inventory reports are tracked | `README.md`, `docs/00.agent-governance/README.md`, `infra/README.md`, `docs/90.references/audits/2026-07-03-workspace-document-contract-audit-pack/frontmatter-inventory.md` | no-action |
...
| Dominant lifecycle and layer keys | `status` appears 519 times; `layer` appears 176 times | `docs/01.requirements/001-gateway.md`, `docs/00.agent-governance/rules/agentic.md` | no-action |
...
| Archive and generated metadata | Archive keys each appear 15 times; `generated_by` appears once | `docs/98.archive/04.execution/plans/2026-05-30-ai-governance-reorg.md`, `docs/90.references/data/0082-llm-wiki-index/README.md` | no-action |
