...
<!-- Target: docs/90.references/audits/ref-0003-ci-qa-parser-graphify-decision.md -->
...
- [Automation coverage map](ref-0002-automation-coverage-map.md) - Supplies the
  original automation gaps and protected-surface boundaries.
- [Gap register](ref-0007-gap-register.md) - Supplies `WDC-GAP-010`,
