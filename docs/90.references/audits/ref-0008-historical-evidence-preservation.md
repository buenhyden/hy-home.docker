...
<!-- Target: docs/90.references/audits/ref-0008-historical-evidence-preservation.md -->
...
- [Frontmatter inventory](ref-0005-frontmatter-inventory.md) - Supplies
  `WDC-GAP-012` audit-baseline evidence.
- [README profile inventory](ref-0009-readme-profile-inventory.md) - Supplies
  `WDC-GAP-012` README baseline evidence.
- [Section profile inventory](ref-0010-section-profile-inventory.md) - Supplies
  `WDC-GAP-013` and `WDC-GAP-014` baseline evidence.
- [Template application gaps](ref-0011-template-application-gaps.md) - Supplies
  `WDC-GAP-015` old-template-path evidence.
- [Gap register](ref-0007-gap-register.md) - Supplies dispositions and future
