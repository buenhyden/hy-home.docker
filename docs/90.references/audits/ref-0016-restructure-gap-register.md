...
<!-- Target: docs/90.references/audits/ref-0016-restructure-gap-register.md -->
...
| --- | --- | --- | --- | --- | --- |
| DRA-GAP-001 | Stage 99 support contracts | Closed: Stage 99 support docs now own archive-centered dispositions and destructive target-change preconditions. | `active-canonical` | Done in `PLN-DRA-003` | [Template contract drift](ref-0018-template-contract-drift.md) |
| DRA-GAP-002 | `archive.template.md` and archive guidance | Closed: archive tombstones remain a format template, while disposition conditions are owned by support contracts. | `active-canonical` | Done in `PLN-DRA-003` | [Template contract drift](ref-0018-template-contract-drift.md) |
| DRA-GAP-003 | Tracked Markdown frontmatter | Accepted residual: 184 tracked Markdown files omit top frontmatter; prior routing says this is not a broad rewrite trigger. | `evidence-preserve` | Accepted in `PLN-DRA-007`; revisit only if contract changes. | [Frontmatter profile inventory](ref-0014-frontmatter-profile-inventory.md) |
| DRA-GAP-004 | `docs/90.references/learning/roadmap-v1.md` | Accepted residual: `status: superseded` is an allowed transitional lifecycle value, and this document points to the current `roadmap.md`. | `evidence-preserve` | Accepted in `PLN-DRA-007`; revisit only if Stage 90 archive policy changes. | [Frontmatter profile inventory](ref-0014-frontmatter-profile-inventory.md) |
| DRA-GAP-005 | Completed `docs/03.specs` files | Closed: completed Stage 03 specs were reviewed and retained as evidence or active inputs; no archive tombstone was justified. | `evidence-preserve` | Done in `PLN-DRA-004` | [SDLC spec archive candidates](ref-0017-sdlc-spec-archive-candidates.md) |
| DRA-GAP-006 | Draft `docs/03.specs` files | Closed: current and implemented draft rows were reclassified; the later agentic-engineering audit-pack design was implemented and marked completed. No Stage 03 draft rows remain. | `active-canonical` / `evidence-preserve` / `completed` | Done in `PLN-DRA-004`; refreshed by 2026-07-05 lifecycle cleanup | [SDLC spec archive candidates](ref-0017-sdlc-spec-archive-candidates.md) |
| DRA-GAP-007 | Current document restructure spec | Closed: current design spec and README are active for this wave. | `active-canonical` | Done in `PLN-DRA-004` | [SDLC spec archive candidates](ref-0017-sdlc-spec-archive-candidates.md) |
| DRA-GAP-008 | Operations bucket taxonomy | Closed: the full `00-workspace`, `01-*` through `12-*`, and legacy `90-knowledge` surface was reviewed; only the legacy LLM Wiki maintenance bucket required movement. | `active-canonical` / evidence-preserve | Done in `PLN-DRA-005` | [Operations bucket restructure](ref-0015-operations-bucket-restructure.md) |
| DRA-GAP-009 | Operations guide/policy/runbook roles | Closed: guide, policy, and runbook roles stayed separate while LLM Wiki maintenance moved from `90-knowledge` into `00-workspace`. | `active-canonical` / resolved historical bucket | Done in `PLN-DRA-005` | [Operations bucket restructure](ref-0015-operations-bucket-restructure.md) |
| DRA-GAP-010 | CI/CD and QA gates | Closed for this wave: existing gates cover the restructure validation set; dependency-audit and Graphify hard gates remain future Security/QA candidates. | `evidence-preserve` / future hardening candidate | Done in `PLN-DRA-006`; future gate work requires a new exact approval. | [CI, QA, and formatting contract](ref-0013-ci-qa-formatting-contract.md) |
| DRA-GAP-011 | Workflow and validator surfaces | Closed for this wave: workflow and script surfaces stayed protected and unchanged. | `active-canonical` | Done in `PLN-DRA-006`; future mutation must update workflow, ruleset, governance, and repo-contract coupling together. | [CI, QA, and formatting contract](ref-0013-ci-qa-formatting-contract.md) |
| DRA-GAP-012 | Historical evidence | Accepted residual: prior audit reports and completed work products should not be rewritten for style alone. | `evidence-preserve` | Accepted in `PLN-DRA-007`; preserve unless active-consumption conflict is proven. | [Template contract drift](ref-0018-template-contract-drift.md), [SDLC spec archive candidates](ref-0017-sdlc-spec-archive-candidates.md) |
...
| 2026-07-05 | DRA-GAP-006 | Refreshed after lifecycle cleanup | The agentic-engineering implementation audit-pack design is now completed after its Stage 90 audit pack and Stage 04 evidence were implemented. Current Stage 03 status scan has zero draft rows. | No future agentic audit-pack approval item remains. |
...
- [Template contract drift](ref-0018-template-contract-drift.md) - Supplies Stage 99 disposition contract findings.
- [Frontmatter profile inventory](ref-0014-frontmatter-profile-inventory.md) - Supplies frontmatter and lifecycle findings.
- [SDLC spec archive candidates](ref-0017-sdlc-spec-archive-candidates.md) - Supplies Stage 03 candidate findings.
- [Operations bucket restructure](ref-0015-operations-bucket-restructure.md) - Supplies operations bucket findings and `PLN-DRA-005` closure evidence.
- [CI, QA, and formatting contract](ref-0013-ci-qa-formatting-contract.md) - Supplies automation findings.
