...
<!-- Target: docs/90.references/audits/ref-0034-agent-catalog-audit.md -->
...
| Field | Disposition |
| --- | --- |
| Canonical destination | [Instruction, catalog, vibe-coding, and model audit](ref-0020-agent-instructions-catalog-vibe-models.md). |
...
- [Canonical agent audit](ref-0020-agent-instructions-catalog-vibe-models.md) - current criteria and dispositions.
