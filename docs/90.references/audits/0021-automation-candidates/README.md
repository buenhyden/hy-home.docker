...
| Provider hooks | Implemented | `.claude/hooks/`, `.codex/hooks.json`, `.gemini/settings.json`, `.gemini/hooks/`, [Gemini provider notes](../../00.agent-governance/providers/gemini.md), [provider hook parity matrix](../../data/0072-provider-hook-parity-matrix/README.md) | Native tracked settings/hooks and the provider hook-parity owner are generated and freshness-checked; live provider interception remains unproved. |
