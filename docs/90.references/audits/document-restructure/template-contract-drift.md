...
<!-- Target: docs/90.references/audits/document-restructure/template-contract-drift.md -->
...
- [Historical evidence preservation](../document-contracts/historical-evidence-preservation.md) - Supplies the prior preserve-old-evidence decision.
