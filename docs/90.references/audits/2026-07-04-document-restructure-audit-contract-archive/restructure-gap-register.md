...
| DRA-GAP-006 | Draft `docs/03.specs` files | Closed: current and implemented draft rows were reclassified; the later agentic-engineering audit-pack design was implemented and marked completed. No Stage 03 draft rows remain. | `active-canonical` / `evidence-preserve` / `completed` | Done in `PLN-DRA-004`; refreshed by 2026-07-05 lifecycle cleanup | [SDLC spec archive candidates](./sdlc-spec-archive-candidates.md) |
