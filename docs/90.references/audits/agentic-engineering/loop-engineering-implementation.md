...
<!-- Target: docs/90.references/audits/agentic-engineering/loop-engineering-implementation.md -->
...
| Eval / semantic scoring loop | Partially Implemented | [loop research](../../research/agentic-engineering/loop-engineering.md), scripts/CI surface | Research and QA concepts exist, but general-purpose agent-output eval is not a full CI gate. |
...
- [Loop engineering research](../../research/agentic-engineering/loop-engineering.md) - criteria source.
...
- [Research pack](../../research/agentic-engineering/README.md)
