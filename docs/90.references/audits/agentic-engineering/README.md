...
<!-- Target: docs/90.references/audits/agentic-engineering/README.md -->
...
`docs/90.references/audits/agentic-engineering` holds implementation-status
...
- [Agentic engineering research pack](../../research/agentic-engineering/README.md)
