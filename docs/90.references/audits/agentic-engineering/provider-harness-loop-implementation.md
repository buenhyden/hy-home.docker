...
<!-- Target: docs/90.references/audits/agentic-engineering/provider-harness-loop-implementation.md -->
...
- [Provider comparison research](../../research/agentic-engineering/provider-implementation-comparison.md) - research baseline.
