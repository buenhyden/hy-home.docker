...
| Generated LLM Wiki index | `docs/90.references/data/0082-llm-wiki-index/README.md` includes `docs/99.templates/README.md` as a generated path entry. | generated artifact | no-action | Regeneration owns this entry; do not hand-edit generated index content. |
