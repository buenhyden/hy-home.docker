...
- `bash scripts/validation/check-repo-contracts.sh` — `failures=4`. The counter
  reports failing *subjects*, not failing lines; the four subjects emit 12 FAIL
  lines between them:
...
gate exists. Document *contract* validation
