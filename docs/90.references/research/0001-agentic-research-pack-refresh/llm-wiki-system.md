...
| WIKI-02   | `docs/90.references/data/0082-llm-wiki-index/README.md`                                 | Hand-authored         | 85 lines, 4,689 bytes                                                                                      | Korean                | Folder index and category boundary                         |
| WIKI-03   | `docs/90.references/data/0082-llm-wiki-index/repository-map.md`                         | Hand-authored         | 95 lines, 5,834 bytes                                                                                      | English               | Eleven-row need-to-canonical-source table                  |
| WIKI-04   | `docs/90.references/data/0082-llm-wiki-index/README.md`                         | Generated             | 1,458 lines, 198,714 bytes, 1,324 path rows in 12 `###` subsections under one `## Generated Index` heading | Mixed, English-exempt | Deterministic path index                                   |
| WIKI-05   | `docs/90.references/data/0076-llm-wiki-stage-category-coverage/README.md` | Generated             | Coverage snapshot                                                                                          | English               | Counts safe paths by bucket, category, and role            |
...
- [LLM Wiki category README](../../data/0082-llm-wiki-index/README.md)
