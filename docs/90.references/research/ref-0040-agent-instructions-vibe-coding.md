...
<!-- Target: docs/90.references/research/ref-0040-agent-instructions-vibe-coding.md -->
...
[AI agent catalogs](ref-0042-ai-agent-catalogs.md) owns third-party role intake, and
[quality/CI](ref-0053-quality-ci-formatting.md) owns the tracked evidence-surface
...
- [Spec 123](../../03.specs/spec-0123-agentic-engineering-audit-remediation/spec.md) - approved instruction/vibe and task-evidence constraints
...
- [document metadata and lifecycle](ref-0045-document-metadata-lifecycle.md)
