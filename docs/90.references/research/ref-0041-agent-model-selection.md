...
<!-- Target: docs/90.references/research/ref-0041-agent-model-selection.md -->
...
[`provider-model-landscape.md`](ref-0052-provider-model-landscape.md) at the fixed
...
- [Provider model landscape](ref-0052-provider-model-landscape.md) - 145-row structural catalog, 142-row exact-cutoff-qualified subset, dated exact-ID remediation evidence, lifecycle normalization, official sources, and task-fit inference
...
- [provider model landscape](ref-0052-provider-model-landscape.md)
- [provider implementation comparison](ref-0051-provider-implementation-comparison.md)
- [ai agent catalogs](ref-0042-ai-agent-catalogs.md)
