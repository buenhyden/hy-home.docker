...
<!-- Target: docs/90.references/research/ref-0058-workspace-baseline.md -->
...
[provider](ref-0051-provider-implementation-comparison.md),
[harness](ref-0047-harness-engineering.md), [loop](ref-0049-loop-engineering.md),
[catalog](ref-0042-ai-agent-catalogs.md), [QA](ref-0053-quality-ci-formatting.md),
[automation](ref-0043-automation-pipeline-workflow.md),
[Compose](ref-0044-docker-compose-infrastructure.md), and
[security](ref-0056-security-governance.md) references. Those documents close the
...
- Claude and Codex documentation facts cited in those sections are owned by the
  [provider implementation comparison](ref-0051-provider-implementation-comparison.md)
...
- [Provider implementation comparison](ref-0051-provider-implementation-comparison.md) - owner of the Claude and Codex documentation facts used by the convergence section
...
- [spec-driven development and SDLC](ref-0057-spec-driven-sdlc.md)
- [SDLC and operations document-type roles](ref-0055-sdlc-document-roles.md)
- [agent model selection](ref-0041-agent-model-selection.md)
