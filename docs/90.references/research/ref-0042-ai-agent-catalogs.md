...
<!-- Target: docs/90.references/research/ref-0042-ai-agent-catalogs.md -->
...
[`agent-instructions-vibe-coding.md`](ref-0040-agent-instructions-vibe-coding.md).
...
- [agent instructions and safe vibe coding](ref-0040-agent-instructions-vibe-coding.md)
- [subagent protocol](../../00.agent-governance/subagent-protocol.md)
