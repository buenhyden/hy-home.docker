...
<!-- Target: docs/90.references/research/ref-0045-document-metadata-lifecycle.md -->
...
policy. [SDLC document roles](ref-0055-sdlc-document-roles.md) owns artifact purpose;
...
- [Diataxis](https://diataxis.fr/) - separation of tutorials, how-to guidance, reference, and explanation. **UNVERIFIED:** the rendered site returns HTTP 429 with `cf-mitigated: challenge` to automated clients and served no content on 2026-08-07. Framework text is verified only from the upstream source repository; see [documentation architecture](ref-0046-documentation-architecture.md)
...
- [Spec 123](../../03.specs/spec-0123-agentic-engineering-audit-remediation/spec.md) - approved metadata keys, audit fields, transition state machine, numbering, and rollout
- Spec 129 - canonical families, README profiles, parent serialization, Release, and staged foundation scope
...
- [SDLC document roles](ref-0055-sdlc-document-roles.md)
- [spec-driven SDLC](ref-0057-spec-driven-sdlc.md)
- [agent instructions and vibe coding](ref-0040-agent-instructions-vibe-coding.md)
