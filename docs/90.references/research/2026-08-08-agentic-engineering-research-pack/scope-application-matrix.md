...
the planned research leaves, and separates real workspace surfaces from typed
...
different findings and must not be merged.
...
- Applicability to all nineteen leaves in the planned pack.
...
Applicable leaf names below refer to the flat nineteen-leaf pack contract in
...
| --- | --- | --- | --- |
| [Persona protocol](../../../00.agent-governance/rules/persona.md) | 2026-08-08 | Tracked mutable | Verified directly; fourteen persona/scope mappings. |
| [Agent catalog](../../../00.agent-governance/contracts/agent-catalog.yaml) | 2026-08-08 | Tracked mutable | Complete YAML parsed; 8 scope values, 14 agents, 24 functions. |
| [All scope files](../../../00.agent-governance/scopes/) | 2026-08-08 | Tracked mutable | Fourteen sorted Markdown files read directly. |
| [Spec 137](../../../03.specs/137-agentic-research-pack-rebuild/spec.md) | 2026-08-08 | Tracked fixed baseline | Verified at active Spec commit `35318255`; owns REQ-32 and pack leaves. |
| [Implementation Plan](../../../04.execution/plans/2026-08-08-agentic-research-pack-rebuild.md) | 2026-08-08 | Tracked mutable | Verified at the Task baseline; owns exact derivations and review gates. |
| [Workspace baseline](./workspace-baseline.md) | 2026-08-08 | Tracked draft | Companion measured inventory at `528c225d`. |
