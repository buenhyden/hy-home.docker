...
| [Predecessor scope matrix](../2026-07-05-agentic-research-pack-refresh/scope-application-matrix.md)    | 2026-08-14 | Historical retained    | Read for structural comparison only; its dispositions were re-derived rather than carried forward.                    |
