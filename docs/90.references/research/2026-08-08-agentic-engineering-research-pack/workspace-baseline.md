...
| [Persona protocol](../../../00.agent-governance/rules/persona.md)                                      | 2026-08-14 | Tracked mutable        | Re-read in full; fourteen persona-to-scope rows confirmed at lines 25-38; unchanged since 2026-05-15.           |
...
| [Stage authoring matrix](../../../00.agent-governance/rules/stage-authoring-matrix.md)                 | 2026-08-14 | Tracked mutable        | Re-verified directly; Stage 90 remains advisory.                                                                |
...
| [Predecessor workspace baseline](../2026-07-05-agentic-research-pack-refresh/workspace-baseline.md)    | 2026-08-14 | Historical retained    | Read for delta analysis only; its `.claude/` 49 and 24,597 B chain figures are superseded and explained above.  |
