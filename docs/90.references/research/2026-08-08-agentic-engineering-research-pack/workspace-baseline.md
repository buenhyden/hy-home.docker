...
`55809319e462ed6ae9ed4a3f31055fc55c2a2294` on 2026-08-11. The original commit
remains valid historical provenance for counts that did not change between the
two measurements.
...
All results use the 2026-08-11 re-derivation commit unless marked otherwise.
Counts produced from `git ls-files` exclude ignored-local and untracked paths.

| Measurement                              | Derivation                                                                      |    Result |
| ---------------------------------------- | ------------------------------------------------------------------------------- | --------: |
| Tracked paths                            | `git ls-files > /tmp/agentic-research-tracked-paths.txt; wc -l ...`             |     1,672 |
...
| Script files / validation files          | `git ls-files scripts` and `git ls-files scripts/validation`                    |   64 / 42 |
...
| ------------------------------------------------------------- | ------------: | ------------------------------------------------------------------------------------------------ |
| [Stage 00 governance](../../../00.agent-governance/README.md) |           110 | Policy, scopes, agents, functions, typed contracts, provider rules, and Memory routing.          |
...
| [Stage 04 execution](../../../04.execution/README.md)         |           238 | 104 Plan-path files, 133 Task-path files, and the stage index.                                   |
...
| [Stage 90 references](../../../90.references/README.md)       |           118 | 97 pre-existing plus the 21 files (README and twenty leaves) of this research pack, now tracked. |
...
approved 2026-08-09 amendment's twentieth row for V&V. The 2026-08-11
re-derivation above updates the path/file counts this table cites; it does not
change any leaf's implementation status. `Current evidence` is a tracked
starting point, not a substitute for each leaf's source and claim review.

| Research leaf / category                | Current tracked evidence                                                                                                  | Baseline state and limit                                                                                                                                                                                                      |
| --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `workspace-baseline.md`                 | 1,672-path inventory and typed registries                                                                                 | Implemented by this draft; independent review pending.                                                                                                                                                                        |
...
| `spec-driven-sdlc.md`                   | 28 active Spec directories and 238 Stage 04 files                                                                         | Implemented as a document system; enforcement strength requires per-gate evidence.                                                                                                                                            |
...
| `automation-pipeline-workflow.md`       | 64 scripts, 7 workflows, and 23 jobs                                                                                      | Partial; tracked orchestration exists, remote execution and deployment are unverified.                                                                                                                                        |
...
| ---------------------------------------------------------------------------------------------------------- | ---------- | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Spec 137](../../../03.specs/137-agentic-research-pack-rebuild/spec.md)                                    | 2026-08-11 | Tracked fixed baseline | Re-verified at current commit `af37969b` (2026-08-09); the amendment there adds REQ-36 and the twenty-one-file cardinality for `verification-validation.md`. REQ-31 and this leaf's twenty-leaf/twenty-one-file counts are unchanged. |
| [Implementation Plan](../../../04.execution/plans/2026-08-08-agentic-research-pack-rebuild.md)             | 2026-08-11 | Tracked mutable        | Re-verified at current commit `0b9bd01b` (2026-08-10); later revisions add Gate 9/V&V evidence unrelated to REQ-31's derivations, which are unchanged.                                                                                |
| [Agent catalog](../../../00.agent-governance/contracts/agent-catalog.yaml)                                 | 2026-08-11 | Tracked mutable        | Re-parsed at current HEAD; unchanged since 2026-08-08 access (last modified 2026-07-26).                                                                                                                                              |
| [Provider-model contract](../../../00.agent-governance/contracts/provider-models.yaml)                     | 2026-08-11 | Tracked mutable        | Re-parsed at current HEAD; unchanged since 2026-08-08 access (last modified 2026-07-26).                                                                                                                                              |
| [Persona protocol](../../../00.agent-governance/rules/persona.md)                                          | 2026-08-11 | Tracked mutable        | Re-verified directly; unchanged since 2026-08-08 access (last modified 2026-05-15); names all fourteen persona scopes.                                                                                                                |
| [Stage authoring matrix](../../../00.agent-governance/rules/stage-authoring-matrix.md)                     | 2026-08-11 | Tracked mutable        | Re-verified directly; unchanged since 2026-08-08 access; Stage 90 remains advisory.                                                                                                                                                   |
