...
All nine minimum official pages were reopened directly at
`2026-08-08T15:48:51+09:00`. Each returned HTTP 200 at the requested URL with
...
| C-AGENT | [Claude subagents](https://code.claude.com/docs/en/sub-agents) | Verified: required/optional frontmatter, model, effort, permissions, skills, hooks, memory, isolation. |
| C-SET | [Claude settings](https://code.claude.com/docs/en/settings) | Verified: scopes, precedence, and project settings. |
| C-MEM | [Claude memory](https://code.claude.com/docs/en/memory) | Verified: instruction hierarchy, imports, auto memory, and context-versus-enforcement boundary. |
| O-HOOK | [Codex hooks](https://learn.chatgpt.com/docs/hooks) | Verified: 11 named events, configuration/trust, decisions, and main-thread `SessionEnd`. |
| O-AGENT | [Codex subagents](https://learn.chatgpt.com/docs/agent-configuration/subagents) | Verified: orchestration, required TOML fields, model/reasoning, sandbox/permission inheritance. |
