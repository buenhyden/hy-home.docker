...
| --- | --- | --- | --- | --- | --- |
| `LWS-001` | `llms.txt` is a thin authored entry point and the generated repository map at `docs/90.references/data/0083-repository-map/README.md` is curated; old operations links are not current truth. | tracked workspace configuration | VERIFIED | `llms.txt`; repository map | Resolve authority from the target's current owner. |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `LWS-SRC-001` | `LWS-001` | LLM entry and repository map / workspace | [llms.txt](../../../../llms.txt); [repository map](../../data/0083-repository-map/README.md) | tracked workspace configuration | `29d947b4bec58bec35d8555c27f2b3550634fe43` | 2026-08-28 | Curated map can contain obsolete links. |
