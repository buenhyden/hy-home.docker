...
Observed research baseline: `main@71da6654e2fa3def174b238ad309c92fe46e9dae`. The
...
recorded; this section preserves that dated observation, not the current main
tip, without rewriting either record. RES-0085 continues to preserve the `4c6d2111` request and
recovery evidence.
...
This revalidation preserves dated evidence only. It does
