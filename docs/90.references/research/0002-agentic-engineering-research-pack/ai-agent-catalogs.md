...
| [Canonical role files](../../../00.agent-governance/agents/agents/)                                                                                                                          | 2026-08-14                        | Workspace tracked           | Direct `wc -l`: 14 files, 672 tracked lines, confirming the local-density comparison.               |
| [Governance contract validator](../../../../scripts/validation/agent_governance_contract.py)                                                                                                 | 2026-08-14                        | Workspace tracked           | `EXPECTED_AGENT_COUNT = 14`, `EXPECTED_FUNCTION_COUNT = 24` at lines 69-70.                         |
