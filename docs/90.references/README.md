...
- [audits/agentic-engineering/README.md](./audits/agentic-engineering/README.md) - agentic engineering implementation-status audit pack
- [audits/agentic-engineering/implementation-overview.md](./audits/agentic-engineering/implementation-overview.md) - cross-category implementation-status snapshot
- [audits/agentic-engineering/harness-engineering-implementation.md](./audits/agentic-engineering/harness-engineering-implementation.md) - harness engineering implementation audit
- [audits/agentic-engineering/loop-engineering-implementation.md](./audits/agentic-engineering/loop-engineering-implementation.md) - loop engineering implementation audit
- [audits/agentic-engineering/provider-harness-loop-implementation.md](./audits/agentic-engineering/provider-harness-loop-implementation.md) - Claude, Codex, and Gemini harness/loop implementation audit
- [audits/agentic-engineering/workspace-rules-environment-implementation.md](./audits/agentic-engineering/workspace-rules-environment-implementation.md) - workspace rules, environment, Docker Compose, and infrastructure implementation audit
- [audits/agentic-engineering/automation-candidates.md](./audits/agentic-engineering/automation-candidates.md) - automation, pipeline, and workflow candidate report
- [audits/agentic-engineering/sdlc-quality-formatting-implementation.md](./audits/agentic-engineering/sdlc-quality-formatting-implementation.md) - SDLC, CI/CD, QA, formatting, linting, and security quality audit
- [audits/document-restructure/README.md](./audits/document-restructure/README.md) - document restructure audit, archive, contract, and QA reference pack
...
- [research/agentic-engineering/README.md](./research/agentic-engineering/README.md) - harness, loop, provider, SDLC, QA research pack index
- [research/agentic-engineering/workspace-baseline.md](./research/agentic-engineering/workspace-baseline.md) - workspace purpose, roles, gates, contracts, scripts, governance baseline
- [research/agentic-engineering/harness-engineering.md](./research/agentic-engineering/harness-engineering.md) - harness engineering components and workspace application analysis
- [research/agentic-engineering/loop-engineering.md](./research/agentic-engineering/loop-engineering.md) - agent, eval, CI, human approval loop analysis
- [research/agentic-engineering/spec-driven-sdlc.md](./research/agentic-engineering/spec-driven-sdlc.md) - spec-driven development and SDLC mapping
- [research/agentic-engineering/quality-ci-formatting.md](./research/agentic-engineering/quality-ci-formatting.md) - CI/CD, QA, formatting, and secure quality gate analysis
- [research/agentic-engineering/provider-implementation-comparison.md](./research/agentic-engineering/provider-implementation-comparison.md) - Claude, Codex, Gemini provider implementation comparison
