...
layer: 08-ai
**Overview (KR):** 로컬 Ollama 서버와 통합 웹 UI를 통해 GPU 가속 기반의 개인용 AI 추론 환경을 구축하고 관리하기 위한 요구사항을 정의합니다.
---
...
_Target Directory: `docs/prd/2026-02-27-ai-prd.md`_
...
- **[REQ-AI-FUN-01]** Containerized Ollama serving with GPU passthrough support.
- **[REQ-AI-FUN-02]** Unified Chat Web UI for direct user interaction.
- **[REQ-AI-FUN-03]** Standardized model volume mounting to avoid host duplication.
...
- **Architecture Reference (ARD)**: [[ARD-AI-01] Local AI Architecture Reference](../ard/2026-02-27-ai-ard.md)
- **Technical Specification**: [[REQ-SPEC-AI-01] AI Infrastructure Spec](../specs/2026-02-27-infra-ai-spec.md)
