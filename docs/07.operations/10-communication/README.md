...
- **Standard Usage**: 가용 가이드는 [07.operations](../../07.operations/10-communication/README.md)에서 관리합니다.
- **Step-by-step Procedures**: 실행 지침은 [07.operations](../../07.operations/10-communication/README.md)에서 관리합니다.
...
- **Usage**: [07.operations/10-communication/mail.md](../../07.operations/10-communication/mail.md)
- **Procedure**: [07.operations/10-communication/mail.md](../../07.operations/10-communication/mail.md)
...
> Migrated from `docs/07.operations/10-communication/README.md` during the 2026-05-10 operations taxonomy consolidation.
...
- **Operations Policy**: 운영 정책은 [07.operations](../../07.operations/10-communication/README.md)에서 관리합니다.
- **Procedures**: 긴급 대응 절차는 [07.operations](../../07.operations/10-communication/README.md)에서 관리합니다.
...
- **Infra Layer**: [infra/10-communication/mail/](../../../infra/10-communication/mail/README.md)
- **Operation**: [07.operations/10-communication/mail.md](../../07.operations/10-communication/mail.md)
- **Procedure**: [07.operations/10-communication/mail.md](../../07.operations/10-communication/mail.md)
