...
status: migrated
---
<!-- Target: docs/07.operations/06-observability/prometheus-recovery.md -->

# Prometheus Recovery Operations

> Migrated from `docs/07.operations/06-observability/prometheus-recovery.md` during the 2026-05-10 operations taxonomy consolidation.
...
이 런북은 `docs/07.operations/06-observability/prometheus-recovery.md` 주제의 실행 절차를 정의한다. 기존 절차를 유지하면서 검증, evidence, rollback 기준을 명확히 한다.
