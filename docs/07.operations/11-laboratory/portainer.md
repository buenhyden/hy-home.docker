...
- **System Usage**: `[../../07.operations/11-laboratory/portainer.md]`
- **Procedure**: `[../../07.operations/11-laboratory/portainer.md]`

---

## Overview (KR)

이 문서는 `docs/07.operations/11-laboratory/portainer.md` 주제의 운영 정책을 정의한다. 기존 운영 내용을 유지하면서 적용 범위, 통제, 검증 기준을 명시한다.
...
> Migrated from `docs/07.operations/11-laboratory/portainer.md` during the 2026-05-10 operations taxonomy consolidation.
...
- **Operation**: `[../../07.operations/11-laboratory/portainer.md]`
- **Procedure**: `[../../07.operations/11-laboratory/portainer.md]`
...
- **Operations**: `[../../07.operations/11-laboratory/portainer.md]`
- **System Usage**: `[../../07.operations/11-laboratory/portainer.md]`
