...
- **Usage**: [../../07.operations/08-ai/optimization-hardening.md](../../07.operations/08-ai/optimization-hardening.md)
- **Procedure**: [../../07.operations/08-ai/optimization-hardening.md](../../07.operations/08-ai/optimization-hardening.md)
- **Catalog**: [../12-infra-service-optimization-catalog.md](../12-infra-service-optimization-catalog.md)

## Usage

> Migrated from `docs/07.operations/08-ai/optimization-hardening.md` during the 2026-05-10 operations taxonomy consolidation.
...
- [Operations Policy](../../07.operations/08-ai/optimization-hardening.md)
