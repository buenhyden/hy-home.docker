...
- **Required**:
  ...
  - 서비스별 운영 문서(`07.operations`)와 실행 절차(`07.operations`)를 상호 링크로 동기화
- **Allowed**:
...
- 문서 추적성 점검:
  - 서비스별 `infra/*/README.md` ↔ `docs/07.operations/*` ↔ `docs/07.operations/*` 상호 링크 확인
...
- **Model / Prompt Change Process**: AI 관련 변경은 `08-ai` 정책 문서 선반영 후 `07.operations/08-ai` 절차로 배포/롤백
