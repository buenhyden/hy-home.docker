<!-- Target: docs/07.operations/04-data/nosql/couchdb.md -->
...
- **Usage**: [CouchDB Cluster Usage](../../../07.operations/04-data/nosql/couchdb.md)
- **Procedure**: [CouchDB Recovery Procedure](../../../07.operations/04-data/nosql/couchdb.md)
...
> Migrated from `docs/07.operations/04-data/nosql/couchdb.md` during the 2026-05-10 operations taxonomy consolidation.
...
- **Infrastructure**: [CouchDB Infrastructure](../../../../infra/04-data/nosql/couchdb/README.md)
- **Operation**: [CouchDB Operations Policy](../../../07.operations/04-data/nosql/couchdb.md)
- **Procedure**: [CouchDB Recovery Procedure](../../../07.operations/04-data/nosql/couchdb.md)
...
- **Usage**: [CouchDB Cluster Usage](../../../07.operations/04-data/nosql/couchdb.md)
- **Operation**: [CouchDB Operation Policy](../../../07.operations/04-data/nosql/couchdb.md)
