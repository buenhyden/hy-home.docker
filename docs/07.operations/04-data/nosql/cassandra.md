<!-- Target: docs/07.operations/04-data/nosql/cassandra.md -->
...
- **Recovery**: [Cassandra Recovery Procedure](../../../07.operations/04-data/nosql/cassandra.md)을 참조하여 복권 수행.
...
- **Usage**: [Cassandra System Usage](../../../07.operations/04-data/nosql/cassandra.md)
- **Procedure**: [Cassandra Recovery Procedure](../../../07.operations/04-data/nosql/cassandra.md)
...
> Migrated from `docs/07.operations/04-data/nosql/cassandra.md` during the 2026-05-10 operations taxonomy consolidation.
...
- **Operation**: [Cassandra Operations Policy](../../../07.operations/04-data/nosql/cassandra.md)
- **Procedure**: [Cassandra Recovery Procedure](../../../07.operations/04-data/nosql/cassandra.md)
...
- **Usage**: [Cassandra System Usage](../../../07.operations/04-data/nosql/cassandra.md)
- **Operation**: [Cassandra Operation Policy](../../../07.operations/04-data/nosql/cassandra.md)
