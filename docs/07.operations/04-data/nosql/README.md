...
- 기술적 시스템 구조 (07.operations/04-data/nosql 참조)
- 긴급 장애 복구 (07.operations/04-data/nosql 참조)
...
- **Usages**: [NoSQL Technical Usages](../../../07.operations/04-data/nosql/README.md)
- **Procedures**: [NoSQL Procedures](../../../07.operations/04-data/nosql/README.md)
...
> Migrated from `docs/07.operations/04-data/nosql/README.md` during the 2026-05-10 operations taxonomy consolidation.
...
- 운영 정책 (07.operations/04-data/nosql 참조)
- 긴급 복구 런북 (07.operations/04-data/nosql 참조)
- 인프라 배포 코드 (infra/04-data/nosql 참조)
...
- **Infrastructure**: [NoSQL Infrastructure](../../../../infra/04-data/nosql/README.md)
- **Operations**: [NoSQL Operations](../../../07.operations/04-data/nosql/README.md)
- **Procedures**: [NoSQL Procedures](../../../07.operations/04-data/nosql/README.md)
...
- 일상적 운영 정책 (07.operations/04-data/nosql 참조)
- 기술적 상세 구조 (07.operations/04-data/nosql 참조)
