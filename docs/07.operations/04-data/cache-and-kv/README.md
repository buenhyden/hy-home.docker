...
2. 정책 위반 사항 발견 시 즉시 담당자에게 보고하고 [Procedure](../../../07.operations/04-data/cache-and-kv/README.md)을 참조합니다.
...
- **Usage**: [04-data Usages](../../../07.operations/04-data/cache-and-kv/README.md)
- **Procedure**: [04-data Procedures](../../../07.operations/04-data/cache-and-kv/README.md)

---

## Overview

`docs/07.operations/04-data/cache-and-kv`는 운영 정책, 통제 기준, 검증 방법을 정의하는 operation 위치다. 이 README는 하위 파일을 찾는 진입점이며, 기존 본문과 실제 디렉터리 구조를 함께 기준으로 사용한다.

## Usage

> Migrated from `docs/07.operations/04-data/cache-and-kv/README.md` during the 2026-05-10 operations taxonomy consolidation.
...
3. 관련 운영 정책은 [07.operations/04-data/cache-and-kv/README.md](../../../07.operations/04-data/cache-and-kv/README.md)를 확인합니다.
...
- **Implementation**: [infra/04-data/cache-and-kv/README.md](../../../../infra/04-data/cache-and-kv/README.md)
- **Operation**: [04-data Operations](../../../07.operations/04-data/cache-and-kv/README.md)
- **Procedure**: [04-data Procedures](../../../07.operations/04-data/cache-and-kv/README.md)
...
`docs/07.operations/04-data/cache-and-kv`는 사용자와 운영자가 재현 가능한 작업 방법을 이해하도록 돕는 guide 위치다. 이 README는 하위 파일을 찾는 진입점이며, 기존 본문과 실제 디렉터리 구조를 함께 기준으로 사용한다.
...
2. 모든 복구 작업은 수행 전후로 [Operations](../../../07.operations/04-data/cache-and-kv/README.md) 정책을 준수하는지 확인합니다.
...
`docs/07.operations/04-data/cache-and-kv`는 운영자가 즉시 실행할 수 있는 runbook 위치다. 이 README는 하위 파일을 찾는 진입점이며, 기존 본문과 실제 디렉터리 구조를 함께 기준으로 사용한다.
