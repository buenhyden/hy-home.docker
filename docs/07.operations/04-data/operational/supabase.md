<!-- Target: docs/07.operations/04-data/operational/supabase.md -->
...
> Migrated from `docs/07.operations/04-data/operational/supabase.md` during the 2026-05-10 operations taxonomy consolidation.
