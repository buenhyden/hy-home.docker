...
- **Technical Usage**: [seaweedfs.md](../../../07.operations/04-data/lake-and-object/seaweedfs.md)
- **Recovery Procedure**: [seaweedfs.md](../../../07.operations/04-data/lake-and-object/seaweedfs.md)
...
이 문서는 `docs/07.operations/04-data/lake-and-object/seaweedfs.md` 주제의 운영 정책을 정의한다. 기존 운영 내용을 유지하면서 적용 범위, 통제, 검증 기준을 명시한다.
...
> Migrated from `docs/07.operations/04-data/lake-and-object/seaweedfs.md` during the 2026-05-10 operations taxonomy consolidation.
...
- **Operation**: [SeaweedFS Operations Policy](../../../07.operations/04-data/lake-and-object/seaweedfs.md)
- **Procedure**: [SeaweedFS Recovery Procedure](../../../07.operations/04-data/lake-and-object/seaweedfs.md)
...
- **Technical Usage**: [seaweedfs.md](../../../07.operations/04-data/lake-and-object/seaweedfs.md)
- **Operations Policy**: [seaweedfs.md](../../../07.operations/04-data/lake-and-object/seaweedfs.md)
- **Infrastructure**: [seaweedfs/README.md](../../../../infra/04-data/lake-and-object/seaweedfs/README.md)
...
이 런북은 `docs/07.operations/04-data/lake-and-object/seaweedfs.md` 주제의 실행 절차를 정의한다. 기존 절차를 유지하면서 검증, evidence, rollback 기준을 명확히 한다.
