...
- 실시간 장애 대응 절차 (-> `07.operations/` 담당)
- 시스템 이해 및 사용법 (-> `07.operations/` 담당)
...
3. 정책 수정 후에는 반드시 관련 런북(`07.operations/`)의 실행 절차와의 일치 여부를 확인한다.
...
- **Usages**: [docs/07.operations/04-data/analytics/](../../../07.operations/04-data/analytics/README.md)
- **Procedures**: [docs/07.operations/04-data/analytics/](../../../07.operations/04-data/analytics/README.md)
...
`docs/07.operations/04-data/analytics`는 운영 정책, 통제 기준, 검증 방법을 정의하는 operation 위치다. 이 README는 하위 파일을 찾는 진입점이며, 기존 본문과 실제 디렉터리 구조를 함께 기준으로 사용한다.

## Usage

> Migrated from `docs/07.operations/04-data/analytics/README.md` during the 2026-05-10 operations taxonomy consolidation.
...
3. 문서 수정 시 관련 운영 정책(`07.operations/`) 및 런북(`07.operations/`)과 상호 참조 무결성을 확인한다.
...
- **Operations**: [docs/07.operations/04-data/analytics/](../../../07.operations/04-data/analytics/README.md)
- **Procedures**: [docs/07.operations/04-data/analytics/](../../../07.operations/04-data/analytics/README.md)
...
`docs/07.operations/04-data/analytics`는 사용자와 운영자가 재현 가능한 작업 방법을 이해하도록 돕는 guide 위치다. 이 README는 하위 파일을 찾는 진입점이며, 기존 본문과 실제 디렉터리 구조를 함께 기준으로 사용한다.
...
- 시스템 설계 및 기본 가이드 (-> `07.operations/` 담당)
- 운영 정책 정의 (-> `07.operations/` 담당)
- 일반 사용자 지원 업무
...
3. 런북 실행 전 반드시 관련 운영 정책(`07.operations/`)의 제약 사항을 확인한다.
...
`docs/07.operations/04-data/analytics`는 운영자가 즉시 실행할 수 있는 runbook 위치다. 이 README는 하위 파일을 찾는 진입점이며, 기존 본문과 실제 디렉터리 구조를 함께 기준으로 사용한다.
