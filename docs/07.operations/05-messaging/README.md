# Messaging Operations Policy (07.operations/05-messaging)
...
- 단계별 장애 복구 실행 절차 (-> `07.operations/05-messaging`)
- 개발자 사용 튜토리얼 (-> `07.operations/05-messaging`)
...
- **Procedures**: [../../07.operations/05-messaging/README.md](../../07.operations/05-messaging/README.md)
- **Usages**: [../../07.operations/05-messaging/README.md](../../07.operations/05-messaging/README.md)
...
- **Procedure**: [optimization-hardening.md](../../07.operations/05-messaging/optimization-hardening.md)
...
> Migrated from `docs/07.operations/05-messaging/README.md` during the 2026-05-10 operations taxonomy consolidation.

### Messaging Usages (07.operations/05-messaging)
...
- 운영 통제 정책 정의 (-> `07.operations/05-messaging`)
- 즉시 실행 장애 복구 절차 (-> `07.operations/05-messaging`)
...
- **Plan**: [2026-03-28-05-messaging-optimization-hardening-plan.md](../../05.plans/2026-03-28-05-messaging-optimization-hardening-plan.md)
- **Tasks**: [2026-03-28-05-messaging-optimization-hardening-tasks.md](../../06.tasks/2026-03-28-05-messaging-optimization-hardening-tasks.md)
- **Operation**: [optimization-hardening.md](../../07.operations/05-messaging/optimization-hardening.md)
- **Procedure**: [optimization-hardening.md](../../07.operations/05-messaging/optimization-hardening.md)

#### AI Agent Guidance

1. 메시징 가이드 수정 시 optimization-hardening 문서와 상호 링크를 유지한다.
2. 관리 경로 정책(SSO/middleware) 관련 설명은 `07.operations` 기준과 충돌하지 않아야 한다.
...
### Messaging Procedures (07.operations/05-messaging)
...
- 운영 통제 정의 (-> `07.operations/05-messaging`)
- 교육용/개념 중심 가이드 (-> `07.operations/05-messaging`)
...
- **Operations Policy**: [../../07.operations/05-messaging/README.md](../../07.operations/05-messaging/README.md)
- **Usages**: [../../07.operations/05-messaging/README.md](../../07.operations/05-messaging/README.md)
