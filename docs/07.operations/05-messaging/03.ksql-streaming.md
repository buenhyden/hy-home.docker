...
status: migrated
---
<!-- Target: docs/07.operations/05-messaging/03.ksql-streaming.md -->

# 03.Ksql Streaming Operations

> Migrated from `docs/07.operations/05-messaging/03.ksql-streaming.md` during the 2026-05-10 operations taxonomy consolidation.
...
- **State Store Corruption**: 서버 비정상 종료 시 RocksDB 상태가 깨질 수 있다. `07.operations`를 참조하여 상태 리셋을 수행한다.

#### Related Documents

- [Primary Specification](../../04.specs/05-messaging/spec.md)
- [Kafka Usage](./kafka.md)
- [Recovery Procedure](../../07.operations/05-messaging/README.md)
