...
status: migrated
---
<!-- Target: docs/07.operations/07-workflow/airflow-dag-basics.md -->

# Airflow Dag Basics Operations

> Migrated from `docs/07.operations/07-workflow/airflow-dag-basics.md` during the 2026-05-10 operations taxonomy consolidation.
...
- **Procedure**: [Airflow Worker Recovery](../../07.operations/07-workflow/airflow-worker-recovery.md)
