...
- **REQ-PRD-AI-FUN-05**: `scripts/hardening/check-ai-hardening.sh`와 CI `ai-hardening` job을 제공해야 한다.
...
- **REQ-PRD-AI-MET-01**: `bash scripts/hardening/check-ai-hardening.sh` 실패 0건.
