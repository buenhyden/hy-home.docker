...
- **REQ-PRD-TLG-FUN-04**: `scripts/hardening/check-tooling-hardening.sh`와 CI `tooling-hardening` job을 제공해야 한다.
...
- **REQ-PRD-TLG-MET-01**: `bash scripts/hardening/check-tooling-hardening.sh` 실패 0건.
