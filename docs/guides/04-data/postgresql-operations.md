...
**Overview (KR):** PostgreSQL 라우터 및 데이터베이스 계정 관리 등 필수 운영 과업 설명입니다.
...
Always connect via the **Router** to respect Leader/Replica roles in the `postgresql-cluster` patroni setup.
