...
현재 지원되는 버전은 다음과 같습니다. (The following versions are currently supported.)
...
### 포함해야 할 내용 (What to Include)

- 취약점에 대한 상세 설명 (Detailed description of the vulnerability)
- 재현 방법 (Steps to reproduce)
- 가능한 경우 개념 증명(PoC) 코드 (Proof of concept code if possible)
