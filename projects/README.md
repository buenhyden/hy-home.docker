...
3. README를 갱신할 때는 [`../docs/99.templates/templates/common/readme-stage.template.md`](../docs/99.templates/templates/common/readme-stage.template.md)의 공통 구조를 따릅니다.
