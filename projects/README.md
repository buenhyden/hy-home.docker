...
3. README를 갱신할 때는 [`../docs/99.templates/templates/common/readme-repository.template.md`](../docs/99.templates/templates/common/readme-repository.template.md)의 공통 구조를 따릅니다.
4. 인프라 노출, gateway, secret, 운영 절차가 바뀌면 관련 `infra/`, `docs/03.specs/`, `docs/05.operations/` 문서도 함께 점검합니다.
